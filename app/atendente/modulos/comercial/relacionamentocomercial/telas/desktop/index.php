  	...
  	<div class="span12">
        <div class="box-conteudo">
			...
			<? //} ?>                 
                ...
                <?php $linhaObj->GerarTabela($dadosArray,$_GET["q"], $idioma, 'config_listagem'); ?>
...
<script language="javascript" type="text/javascript">
  jQuery(document).ready(function($) {
    ...
    $("#proxima_acao").mask("99/99/9999");
    $("input[name='q[7|proxima_acao]']").datepicker($.datepicker.regional["pt-BR"]);
  });
</script>
</div>
</body>
