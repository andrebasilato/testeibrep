    ...
    <div class="span12">
      <div class="box-conteudo" style="padding:20px">
        ...
        <script>alert('<?= $idioma[$_POST["msg"]]; ?>');</script>
            ...
            <section id="financeiromatricula">
                ...
                <form method="post" class="form-horizontal">
                    <?php if($matricula["situacao"]["visualizacoes"][2]) { ?>
                    ...
                    <br />
                    <input <? if(!$matricula["situacao"]["visualizacoes"][2] || $matricula['negativada'] == 'S') { ?> disabled="disabled" <? } ?> id="form_negativacao_matricula" class="span2 inputGrande" type="text" value="<?php echo formataData($matricula["data_negativacao"], "br", 0); ?>" name="data_negativacao" />
                    <?php /*&nbsp;
        ...
        <?php } ?>
				  ...
				  <?php if($matricula["situacao"]["visualizacoes"][20]) { ?>
				  ...
				  <?php if($matricula["situacao"]["visualizacoes"][26]) { ?>
