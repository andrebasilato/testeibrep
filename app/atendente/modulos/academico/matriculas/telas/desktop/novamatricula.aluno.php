              ...
              <form method="get" onsubmit="return formulario_documentos(this, regras_documentos)">
                ...
                <div class="control-group">
                  <label class="control-label" for="form_nome"><strong><?=$idioma["form_aluno_cpf"];?></strong></label>
                    <div class="controls">
                      <input id="form_cpf" class="span3 inputGrande" type="text" maxlength="11" name="cpf"<? if($_GET["cpf"] && !count($matricula["erros"])) { ?> readonly="readonly"<? } ?> value="<?= $_GET["cpf"]; ?>">
              ...
              <? if(($_GET["cpf"]) && (!count($matricula["erros"]))) { ?>              
                <section id="formulario_cliente">          
                  ...
                  //direcionar para o financeiro
                    ...
                    //}
                  ?>      
                  <form method="post" action="<?= $action ?>" onsubmit="return valida_form(this, regras)" enctype="multipart/form-data" class="form-horizontal">            
                    <? 
                    if($pessoa["idpessoa"]) {
