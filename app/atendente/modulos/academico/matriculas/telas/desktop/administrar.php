    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="box-conteudo" style="padding:20px">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <?php if($diploma['total']) { ?>
                            <div class="alert alert-success fade in">
                                <a href="javascript:void(0);" class="close" data-dismiss="alert">×</a>
                                <strong><?= sprintf($idioma['msg_matricula_diploma'], $diploma['idfolha'], $diploma['idfolha']); ?></strong>
                            </div>
                        <?php } ?>
                            ...
                            <div id="divSituacoes" style="padding-top:15px; padding-bottom:15px;">
                                ...
                                foreach ($situacaoWorkflow as $ind => $val) {
                                    if ($ind == $matricula["idsituacao"]) {
                                        ...
                                        if (
                                            in_array($ind, $situacaoWorkflowRelacionamento)
                                            && $matricula["situacao"]["visualizacoes"][36]
                        ...
                        <section id="dadosmatricula">
                            ...
                            <table border="0" cellspacing="0" cellpadding="5" class="table table-bordered table-condensed">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if($matricula["situacao"]["visualizacoes"][68]) { ?>
                                ...
                                <?php if ($matricula["forma_pagamento"] == 2 || $matricula["forma_pagamento"] == 3) { ?>
                                    ...
                                    <?php if ($matricula["idpedido"]) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <strong>
                                                    <?php if($matricula['pedido']['pagamento']["status_transacao"]) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <strong>
                                                    <?php if($matricula['pedido']['pagamento']["tid"]) { ?>
                            ...
                            <form method="post" action="" onsubmit="return validateFields(this, regras_dados_matricula)" enctype="multipart/form-data" class="form-horizontal">
                                <?php if($matricula["situacao"]["visualizacoes"][36]) { ?>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td style="padding-right:20px;"><input <?php if(!$matricula["situacao"]["visualizacoes"][36]) { ?> disabled="disabled" <?php } ?> id="form_data_matricula" class="inputData" type="text" value="<?= formataData($matricula["data_matricula"], "br", 0); ?>" name="data_matricula"></td>
                                        <td><input <?php if(!$matricula["situacao"]["visualizacoes"][36]) { ?> disabled="disabled" <?php } ?> id="form_data_expedicao" class="inputData" type="text" value="<?php if($matricula["data_expedicao"] && $matricula["data_expedicao"] != "0000-00-00") echo formataData($matricula["data_expedicao"], "br", 0); ?>" name="data_expedicao"></td>
                                        <td style="padding-left:20px;"><input id="form_data_prolongamento" class="inputData" type="text" value="<?= formataData($matricula["data_prolongada"], "br", 0); ?>" name="data_prolongada" <?php if(!$matricula["situacao"]["visualizacoes"][36]) { ?> disabled="disabled" <?php } ?>></td>
                                        <td style="padding-left:20px;"><input <?php if(!$matricula["situacao"]["visualizacoes"][71]) { ?> disabled="disabled" <?php } ?> id="form_porcentagem" maxlength="6" type="text" value="<?= number_format($matricula["porcentagem_manual"], 2, ",", "."); ?>" class="inputData" name="porcentagem_manual" style="text-align:left;"></td>
                                        <td style="padding-left:20px;"><input id="form_data_conclusao" class="inputData" type="text" value="<?= formataData($matricula["data_conclusao"], "br", 0); ?>" name="data_conclusao" <?php if(!$matricula["situacao"]["visualizacoes"][36]) { ?> disabled="disabled" <?php } ?>></td>
                                    </tr>
                                </table>
                                <br />
                                <table>
                                    ...
                                    <tr>
                                        <td style="padding-right:20px;">
                                            <select <?php if(!$matricula["situacao"]["visualizacoes"][36]) { ?> disabled="disabled" <?php } ?> name="idvendedor" id="form_idvendedor" class="span4">
                                        ...
                                        <td style="padding-right:20px;"><input <?php if(!$matricula["situacao"]["visualizacoes"][36]) { ?> disabled="disabled" <?php } ?> id="form_data_registro" class="inputData" type="text" value="<?= formataData($matricula["data_registro"], "br", 0); ?>" name="data_registro"></td>
                                        <?php //if($matricula['possui_financeiro'] == 'S') { ?>
                                        <td style="padding-left:20px;">
                                            <select <?php if(!$matricula["situacao"]["visualizacoes"][36]) { ?> disabled="disabled" <?php } ?> name="forma_pagamento" id="forma_pagamento" class="span4 " onchange="liberaCamposFormasPagamento(this.options[this.selectedIndex].value);">
                                                <option value=""><?= $idioma["selecione_empresa"]; ?></option>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td style="padding-right:20px;"><input <?php if(!$matricula["situacao"]["visualizacoes"][36]) { ?> disabled="disabled" <?php } ?> id="form_valor_contrato" class="span2 " type="text" value="<?= number_format($matricula["valor_contrato"],2,",","."); ?>" name="valor_contrato"></td>
                                        <td style="padding-right:20px;"><input <?php if(!$matricula["situacao"]["visualizacoes"][36]) { ?> disabled="disabled" <?php } ?> id="form_qtd_parcelas" class="span2 " type="text" value="<?= $matricula["quantidade_parcelas"]; ?>" name="qtd_parcelas"></td>
                                    </tr>
                                </table>
                                <br />
                                <br />
                                <table>
                                    ...
                                    <tr>
                                        <td style="padding-right:20px;"><textarea id="observacao" class="span6 " name="observacao" <?php if(!$matricula["situacao"]["visualizacoes"][36]) { ?>disabled="disabled"<?php } ?>><?= $matricula["observacao"]; ?></textarea></td>
                                    </tr>
                                </table>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td style="padding-right:20px;">
                                            <input <?php if(!$matricula["situacao"]["visualizacoes"][36]) { ?> disabled="disabled" <?php } ?> id="form_renach" class="span3 " type="text" value="<?= $matricula["renach"]; ?>" name="codigo_diploma" maxlength="30">
                                        </td>
                                    </tr>
                                </table>
                ...
                <table>
                  <tr>
                    <td style="padding-right:20px;"><strong><?= $idioma['dados_matricula_data_solicitacao_carteirinha']; ?></strong></td>
                    <td style="padding-right:20px;"><strong><?= $idioma['dados_matricula_situacao_carteirinha']; ?></strong></td>
                  </tr>
                  <tr>
                    <td style="padding-right:20px;"><input <?php if(!$matricula["situacao"]["visualizacoes"][2]) { ?> disabled="disabled" <?php } ?> id="form_data_solicitacao_carteirinha" class="span2 " type="text" value="<?= formataData($matricula["data_solicitacao_carteirinha"], "br", 0); ?>" name="data_solicitacao_carteirinha"></td>
                    <td style="padding-right:20px;">
                        <select name="situacao_carteirinha" id="situacao_carteirinha" class="span4 " <?php if(!$matricula["situacao"]["visualizacoes"][2]) { ?> disabled="disabled" <?php } ?> style="width:auto">
                            <option value=""></option>
                            <?php foreach($situacao_carteirinha_aluno[$config["idioma_padrao"]] as $ind => $situacao) { ?>
                            <option value="<?= $ind; ?>" <?php if($matricula["situacao_carteirinha"] == $ind) { ?>selected="selected"<?php } ?>>
                                <?= $situacao; ?>
                            </option>
                            <?php } ?>
                        </select>
