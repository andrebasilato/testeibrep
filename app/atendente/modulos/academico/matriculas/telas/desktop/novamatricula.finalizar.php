        ...
        <div class="row-fluid">
          <div class="span12">
            <section id="matricula">
              ...
              <a class="btn btn-small" href="/atendente/academico/matriculas/<?= $matricula["idmatricula"]; ?>/administrar" style="margin-bottom:10px; margin-right:10px;"><?= $idioma["btn_administrar"]; ?></a>
              <br />
