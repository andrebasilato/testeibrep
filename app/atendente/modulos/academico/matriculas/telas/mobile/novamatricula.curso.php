			  ...
			  <? } elseif($url[4] && $url[5] && !$url[6]) { ?>
				...
				<?php if(count($ofertaCursoEscolas) > 0) { ?>
                  <section class="blocoDisponibilidade" id="escolas">
                    ...
                    ?>
                        <div class="unidadeDisponibilidade" style="padding:2px 10px 2px 10px;">
				...
				<?php if(count($ofertaCursoEscolas) > 0) { ?>
                  <section class="blocoDisponibilidade" id="turmas">
                    ...
                    ?>
                        ...
                        <div class="unidadeDisponibilidade" style="padding:2px 10px 2px 10px;">
						  <?php if($ofertaTurma["total_turma"] < $escola["limite"]) { ?>
						  ...
						  <?php } else { ?>
							<a href="javascript:void();" onclick="javascript:alert('Turma completa.')" class="btn"  rel="tooltip" title="<?= $idioma["iniciar_matricula"]; ?>"  style="color: #FFFFFF; border-color: #006DCC; text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25); background: #006DCC;">
								<div class="blocoLink"><?= $ofertaTurma["nome"]; ?> (<?= $ofertaTurma["total_turma"]; ?>/<?= $escola["limite"]; ?>)</div>
							  </a>
						  <?php } ?>
                        </div>
