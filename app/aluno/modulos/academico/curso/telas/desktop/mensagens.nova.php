						...
						<div class="abox extra-align">
							<?php if(verificaPermissaoAcesso(false)) { ?>
								<div class="row-fluid">
									<div class="span12">
										<div class="r-align">
											<a href="<?php echo '/'.$url[0].'/'.$url[1].'/'.$url[2].'/'.$matricula['idmatricula'].'/'.$url[4].'/'.$url[5].'/cadastrar'; ?>" class="abrirModal"><div class="btn btn-verde">+ <?php echo $idioma['nova_mensagem']; ?></div></a>
										</div>                        
									</div>
								</div>
								<br />
