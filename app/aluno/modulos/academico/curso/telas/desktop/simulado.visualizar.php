                ...
                <div class="span12">                
                    <div class="abox extra-align">
                        ...
                        <form class="ac-custom ac-radio ac-checkbox ac-fill ac-cross" id="formProva" name="formProva" autocomplete="off" method="post" enctype="multipart/form-data" >
                            ...
                            $ordem = 0;
                            $corretas = 0;
                            foreach ($visualizarSimulado['perguntas'] as $ind => $pergunta) { 
                                $ordem++;
                                ?>
                                <div class="row-fluid">
                                            ...
                                            <ul style="margin: 0;">
                                                ...
                                                foreach ($pergunta['opcoes'] as $opcao) {
                                                    ...
                                                    if($pergunta['multipla_escolha'] == 'S') 
                                                        ...
                                                        ?>
                                                    <li>
                                                                                                            <input id="<?php echo $id; ?>" name="<?php echo $name; ?>" type="<?php echo $type; ?>" value="<?php echo $opcao['idopcao']; ?>" <?php if($opcao['marcada'] == 'S') { ?>checked<?php } ?> disabled><label for="<?php echo $id; ?>"><p><?php if($opcao['correta'] == 'S') { ?><i style="color:green;font-size:26px;" class="icon-ok"></i><?php } else { ?> <i style="color:red;font-size:26px;" class="icon-remove"></i> <?php } ?><?php echo $opcao['ordem']; ?>) <?php echo $opcao['nome']; ?></p></label>
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span6 alert alert-danger text-center" style="font-size:20px;"><strong><?php echo $idioma['erros'].' '.(count($visualizarSimulado['perguntas']) - $corretas); ?></strong></div>
                            </div>
                            <div class="row-fluid">
                                <div class="span12">
                                    ...
                                    <a href="/<?php echo $url[0] ?>/<?php echo $url[1] ?>/<?php echo $url[2] ?>/<?php echo $matricula['idmatricula'] ?>/<?php echo $url[4] ?>/<?php echo $url[5] ?>/<?php echo $url[6] ?>/tentativas" class="btn btn-azul btn-mob"><?php echo $idioma['ver_tentativas']; ?></a>
                                </div>
                            </div>
                        </form> 
                    </div>
