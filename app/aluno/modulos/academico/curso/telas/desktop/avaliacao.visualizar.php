                ...
                <div class="span12">                
                    <div class="abox extra-align">
                                ...
                                <div class="row-fluid show-grid">
                                    <div class="span12 description-item">
                                        <div class="span8">
                                            ...
                                            <p><?php echo $idioma['periodo']; ?> <strong><?php echo formataData($prova['inicio'],'br',1).' - '.formataData($prova['fim'],'br',1); ?></strong></p>
                                            <p><?php echo $idioma['nota']; ?> <strong><?php echo number_format($prova['nota'],1,',','.'); ?></strong></p>
                                        </div>                               
                                    </div>
                                </div>
                            </div> 
                        ...
                        <form class="ac-custom ac-radio ac-checkbox ac-fill ac-cross" id="formProva" name="formProva" autocomplete="off" method="post" enctype="multipart/form-data" >
                            <?php 
							$ordem = 0;
                            #var_dump($prova["perguntas"][0]["opcoes"]);exit;
                                ...
                                <div class="row-fluid">
                                    <div class="span12 extra-align border-box">
                                        ...
                                        foreach ($pergunta['opcoes'] as $opcao) {
                                            ...
                                            if ($opcao["marcada"] == "S" && $opcao["correta"] == "S") {
                                                $pergunta["correta"] = true;
                                            }
                                        }
                                        ?>
                                        <div class="pull-right acertou-errou">
                                        <?php if ($pergunta["correta"]) { ?>
                                                <i style="color: #6BA256;cursor:pointer;" class="icon-ok" aria-hidden="true"></i> <?= $idioma["acertou"]; ?>
                                        <?php } else { ?>
                                                <i class="icon-remove" aria-hidden="true"></i> <?= $idioma["errou"]; ?>
                                        <?php } ?>
                                        </div>
                                            ...
                                            <ul style="margin: 0;">
												...
												foreach ($pergunta['opcoes'] as $opcao) {
													...
													if($pergunta['multipla_escolha'] == 'S') 
														...
														?>
                                                    <li>
                                                        <input id="<?php echo $id; ?>" name="<?php echo $name; ?>" type="<?php echo $type; ?>" value="<?php echo $opcao['idopcao']; ?>" <?php if($opcao['marcada'] == 'S') { ?>checked<?php } ?> disabled><label for="<?php echo $id; ?>"><?php echo $opcao['ordem']; ?>) <?php echo $opcao['nome']; ?></label>
                                        ...
                                        <?php } else { ?>
                                            <textarea name="respostas_subjetivas[<?php echo $pergunta['id_prova_pergunta']; ?>]" id="respostas_subjetivas[<?php echo $pergunta['id_prova_pergunta']; ?>]" class="span12" style="height:120px;" disabled><?php echo nl2br($pergunta['resposta']); ?></textarea>
                                        <?php } ?>
                                        <br />
                                        <?php if ($pergunta['arquivo_servidor']) {?>
											<div>
												<?php echo $idioma['anexar_arquivo_aluno']; ?>
                                                <a href="/<?php echo $url[0]; ?>/<?php echo $url[1]; ?>/<?php echo $url[2]; ?>/<?php echo $matricula['idmatricula']; ?>/<?php echo $url[4]; ?>/<?php echo $url[5]; ?>/<?php echo $url[6]; ?>/<?php echo $url[7]; ?>/<?php echo $url[8]; ?>/<?php echo $url[9]; ?>/<?php echo $pergunta['id_prova_pergunta']; ?>/arquivoaluno"><?php echo $pergunta['arquivo']; ?></a>
                                            </div>
										<?php }?>
                                        <br />
                                        <?php if ($pergunta['observacao']) { ?>
                                            <div>
                                                <strong><?php echo $idioma['observacao_professor']; ?></strong>
                                                <textarea name="respostas_subjetivas[<?php echo $pergunta['id_prova_pergunta']; ?>]" id="respostas_subjetivas[<?php echo $pergunta['id_prova_pergunta']; ?>]" class="span12" style="height:120px;" disabled><?php echo nl2br($pergunta['observacao']); ?></textarea>
                                            </div>
										<?php } ?>
                                        <br />
										<?php if ($pergunta['arquivo_professor_servidor']) {?>
											<div>
												<?php echo $idioma['anexar_arquivo_professor']; ?>
                                                <a href="/<?php echo $url[0]; ?>/<?php echo $url[1]; ?>/<?php echo $url[2]; ?>/<?php echo $matricula['idmatricula']; ?>/<?php echo $url[4]; ?>/<?php echo $url[5]; ?>/<?php echo $url[6]; ?>/<?php echo $url[7]; ?>/<?php echo $url[8]; ?>/<?php echo $url[9]; ?>/<?php echo $pergunta['id_prova_pergunta']; ?>/arquivoprofessor"><?php echo $pergunta['arquivo_professor']; ?></a>
                                            </div>
										<?php }?>
                                    </div>
                                </div>
