...
$config["listagem"] = array(
    ...
    array(
        ...
        "tipo" => "php",
        "valor" => 'return "
<a class=\"btn dropdown-toggle btn-mini\" data-original-title=\"".$idioma["tabela_dossie_tooltip"]."\" href=\"/".$this->url["0"]."/".$this->url["1"]."/".$this->url["2"]."/".$linha["idmatricula"]."/dossie\" target=\"_blank\" data-placement=\"left\" rel=\"tooltip\">".$idioma["tabela_dossie"]."</a>&nbsp;
