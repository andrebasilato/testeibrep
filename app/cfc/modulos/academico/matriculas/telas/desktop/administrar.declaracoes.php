...
<? incluirTela("administrar.menu",$config,$matricula); ?>
        ...
        <? if($matricula["situacao"]["visualizacoes"][60]) { ?>
                 ...
                 <div style="float:left">
                  <table cellpadding="5" cellspacing="0" class="table table-bordered table-condensed tabelaSemTamanho">
                    ...
                    <tr>
                      <td>
                        <select name="iddeclaracao" id="iddeclaracao" class="span3" <? if($matricula["situacao"]["visualizacoes"][60]) { ?>onchange="atualizaDeclaracaoGet()"<? } else { ?>disabled="disabled"<? } ?>>
                          <option value=""></option>
