        ...
        <script>alert('<?= $idioma[$_POST["msg"]]; ?>');</script>
            ...
            <section id="documentosmatricula">
              ...
              <? if($matricula["situacao"]["visualizacoes"][69]) { ?>
                    ...
                    if (count($matricula["documentos"]) > 0) {
                        foreach ($matricula["documentos"] as $documento) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    if($matricula["situacao"]["visualizacoes"][71] && $documento["situacao"] != 'aguardando') {
                                        ?>
                                        <a href="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/<?= $url[3]; ?>/<?= $url[4]; ?>/<?= $url[5]; ?>/validardocumento/<?= $documento["iddocumento"]; ?>" rel="facebox" >
                                            <?php
                                        }
                                        ?>
                                        <span class="label" style="background-color:<?= $situacao_documento_cores[$documento["situacao"]]; ?>" <? echo 'rel="tooltip"'; ?>>
                ...
                <?php if($matricula["situacao"]["visualizacoes"][69]) { ?>
