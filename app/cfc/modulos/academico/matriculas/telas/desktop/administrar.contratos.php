...
<?php if($matricula["situacao"]["visualizacoes"][56]) { ?>
...
<?php if($matricula["situacao"]["visualizacoes"][57]) { ?>
...
<?php if($matricula["situacao"]["visualizacoes"][58]) { ?>
...
<? incluirTela("administrar.menu",$config,$matricula); ?>
        ...
        <? if($matricula["situacao"]["visualizacoes"][55]) { ?>
        <? //if($matricula["situacao"]["visualizacoes"][55]) { ?>
                  <script type="text/javascript">
                ...
                <div style="float:left">
                  <table cellpadding="5" cellspacing="0" class="table table-bordered table-condensed tabelaSemTamanho">
                    ...
                    <tr>
                      <td>
                        <select name="idcontrato" id="idcontrato" class="span3" <? if($matricula["situacao"]["visualizacoes"][55]) { ?>onchange="atualizaContratoGet()"<? } else { ?>disabled="disabled"<? } ?>>
                          <option value=""></option>
                ...
                <form method="post" action="" style="float:left; margin-left:10px;" enctype="multipart/form-data">
                  ...
                  <table cellpadding="5" cellspacing="0" class="table table-bordered table-condensed tabelaSemTamanho">
                    ...
                    <tr>
                      <td><input name="contrato" type="file" id="contrato" <? /*if(!$matricula["situacao"]["visualizacoes"][55] ) { ?>disabled="disabled"<? }*/ ?>/></td>
                      <td>
                        <select name="idtipo" id="idtipo" style="width:auto" <? /*if(!$matricula["situacao"]["visualizacoes"][55]) { ?>disabled="disabled"<? }*/ ?>>
                          <? foreach($tiposContratos as $tipo) { ?>
                            <option value="<?= $tipo["idtipo"]; ?>"><?= $tipo["nome"]; ?></option>
                          <? } ?>
                        </select>
                      </td>
                      <td><input class="btn btn-mini" type="submit" value="<?php echo $idioma["btn_enviar"]; ?>" <? /*if(!$matricula["situacao"]["visualizacoes"][55]) { ?>disabled="disabled"<? }*/ ?> /></td>
                    </tr>
                    <tr>
        ...
        <div style="clear: both;">
            ...
            <br />
                      ...
                      <td>
                        ...
                        if($matricula["situacao"]["visualizacoes"][56]) {
                      ...
                      <td>
                        <?
                        if($matricula["situacao"]["visualizacoes"][57]) {
                          if($contrato["cancelado"]) {
                      ...
                      <td>
                        ...
                        <? } else {?>
                          <? if($matricula["situacao"]["visualizacoes"][58] ) { ?>
