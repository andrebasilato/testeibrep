...
define('INTERFACE_MATRICULA_NOTAS', retornarInterface('matricula_notas')['id']);
$inicioExecucao = tempoExecucao();
$transacoesObj->iniciaTransacao(INTERFACE_MATRICULA_NOTAS, 'S');
...
try {
    ...
    $retorno['dados'] = $matriculaObj->retornarBoletim($aluno['idpessoa']);
