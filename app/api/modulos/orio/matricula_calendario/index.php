...
define('INTERFACE_MATRICULA_CALENDARIO', retornarInterface('matricula_calendario')['id']);
$inicioExecucao = tempoExecucao();
$transacoesObj->iniciaTransacao(INTERFACE_MATRICULA_CALENDARIO, 'E');
...
try {
    ...
    $retorno['dados'] = $matriculaObj->retornarCalendario($aluno['idpessoa']);
