...
define('INTERFACE_MATRICULA_POLOS', retornarInterface('matricula_polos')['id']);
$inicioExecucao = tempoExecucao();
$transacoesObj->iniciaTransacao(INTERFACE_MATRICULA_POLOS, 'S');
...
try {
    ...
    $matriculaObj->campos = 'p.idpolo, p.nome_fantasia';
    $polos = $matriculaObj->retornarPolosProvasDisponiveisAluno($matricula['idinstituicao']);
