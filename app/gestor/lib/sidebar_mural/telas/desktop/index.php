<div class="section section-small">
  ...
  <div class="section-body">
    <div id="blog-posts">
      ...
      <h4 class="post-title"><? if($mural['data_lido'] == ''){ echo "<i class='icon-star'></i>";}?> <a href="/<?= $url[0]; ?>/relacionamento/mural/<?= $mural["idmural"]; ?>/visualizar" <? if($mural['data_lido'] == ''){ ?>style="color:#F00;" <? } ?>><?php echo $mural['titulo']; ?></a> </h4>
