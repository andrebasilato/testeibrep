...
<style type="text/css">
  body {
    ...
    background-image: url("../../../../../assets/img/ibreptran.png");
...
<div class="labelPainel">Painel da Sindicato de Ensino - v<?php echo $config["oraculo_versao"]; ?></div>
  ...
  <div class='row'>
    <div class='span6 offset3'>
      <div class='section section-large' id='login-section'>
        ...
        <? }elseif($_POST["msg"] && $_POST["msg"] != 'gestor_sindicato_sucesso'){ ?>
