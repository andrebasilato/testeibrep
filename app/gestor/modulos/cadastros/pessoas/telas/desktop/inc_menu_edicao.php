<ul class="nav nav-tabs">
  ...
  <li<? if($url[4] == "contatos") { ?> class="active"<? } ?>><a href="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/<?= $url[3]; ?>/contatos"><?= $idioma["tab_contatos"]; ?></a></li>
  <!--<li<? if($url[4] == "associacoes") { ?> class="active"<? } ?>><a href="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/<?= $url[3]; ?>/associacoes"><?= $idioma["associacoes"]; ?></a></li>-->  
  ...
  <li<? if($url[4] == "sindicatos") { ?> class="active"<? } ?>><a href="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/<?= $url[3]; ?>/sindicatos"><?= $idioma["tab_sindicatos"]; ?></a></li>
