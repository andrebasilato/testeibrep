          ...
          <div class="tabbable tabs-left">
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab_editar">
                ...
                <br />
                <div class="row-fluid">
                  <a href="javascript:void(0);" class="span3 botao btn" id="ativarLogin" onclick="ativarLogin('S');">Login ativado</a>
                  <a href="javascript:void(0);" class="span3 botao btn" id="desativarLogin" onclick="ativarLogin('N');">Login desativado</a>
                </div> 
              </div>
            </div>
          </div>
