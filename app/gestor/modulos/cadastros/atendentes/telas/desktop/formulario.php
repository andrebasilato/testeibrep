...
<section id="global">
    ...
    <ul class="breadcrumb">
        ...
        <? } else { ?>
            <li class="active"><?php echo strlen($linha["nome"]) > 30 ? mb_strimwidth($linha["nome"], 0, 40, "...") : $linha["nome"]; ?></li>
        <? } ?>
...
<div class="row-fluid">
    <div class="span12">
        <div class="box-conteudo">
            ...
            <?php if ($url[3] != "cadastrar") { ?><h2 class="tituloEdicao"><?php echo strlen($linha["nome"]) > 30 ? wordwrap($linha["nome"], 20, " ", true) : $linha["nome"]; ?></h2><?php } ?>
