...
$config["formulario"] = array(
    array(
        ...
        "campos" => array(
            ...
            array(
                "id" => "form_atendente_padrao",
                "nome" => "atendente_padrao",
                "nomeidioma" => "form_atendente_padrao",
                "tipo" => "select",
                "array" => "sim_nao",
                "valor" => "atendente_padrao",
                "validacao" => array("required" => "atendente_padrao_vazio"),
                "class" => "span2",
                "banco" => true,
                "banco_string" => true,
            ),
    ...
    array(
        "fieldsetid" => "dados_documentos",
        "legendaidioma" => "legenda_dados_documentos",
        "campos" => array(
            array(
                "id" => "form_tipo",
                "nome" => "documento_tipo",
