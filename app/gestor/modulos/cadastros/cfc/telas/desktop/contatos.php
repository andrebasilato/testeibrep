			 		...
			 		<?php incluirTela("inc_menu_edicao",$config,$usuario); ?>
              		<div class="tab-content">
                		<div class="tab-pane active" id="tab_editar">
                            ...
                            <form class="form-inline wellCinza" method="post" onsubmit="return validaValor()">
                                ...
                                <select name="idtipo" id="idtipo" style="width:auto">
                                  ...
                                  <option value="<?= $val["idtipo"]; ?>" alt="<?= $val["mascara"] ?>"><?= $val["nome"]; ?></option>
                                  <? } ?>
                                </select>
                                &nbsp;
										...
										<?php foreach($associacoesArray as $ind => $associacao) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                  ...
                                                  <a href="javascript:void(0);" class="btn btn-mini" data-original-title="<?= $idioma["btn_remover"]; ?>" data-placement="left" rel="tooltip" onclick="remover(<?php echo $associacao["idcontato"]; ?>)"><i class="icon-remove"></i></a>
                                                  <?php } else { ?>
