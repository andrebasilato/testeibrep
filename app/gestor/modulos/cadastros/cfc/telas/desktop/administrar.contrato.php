    ...
    <td>
      <table width="99%" border="0" cellspacing="0" cellpadding="5" align="center">
        <tr>
          ...
          <td align="center">
			<?=$idioma["escola_id"];?> <?= $contrato["idescola"]; ?>
            <br />
            <strong><?= $contrato["contrato"]; ?> (<?= $contrato["tipo"]; ?>)</strong>
          </td>
          <td align="right"><a class="btn btn-small" onclick="imprimirContrato('frame_contrato', '5%', '5%', '90%', '90%');"><i class="icon-print"></i><?=$idioma["escola_imprimir"];?></a></td>
        </tr>
      </table>
    </td>
  </tr>
