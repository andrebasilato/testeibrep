                        ...
                        <div class="tab-pane active" id="tab_editar">
                            ...
                            <form method="POST" id="form-dados">
                                ...
                                <table class="table table-striped tabelaSemTamanho">
                                    <thead>
                                        <tr>
                                            <th><?= $idioma["listagem_disponivel_cfc"]; ?></th>
...
<!--                                            <th><?/*= $idioma["listagem_avista"]; */?></th>
                                            ...
                                            <th><?= $idioma["qtd_parcelas"]; ?></th>
                                            <th><?= $idioma["formas_pagamentos"]; ?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <?php if (count($cursos) > 0) { ?>
                                        <?php foreach ($cursos as $curso) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <input <?= ($curso['disponivel_cfc'] == 'S') ? 'checked' : '' ?> id="<?= $curso['idcurso'] ?>" class="idcurso" name="valores[<?= $curso['idcurso'] ?>][disponivel_cfc]" type="checkbox">
                                                </td>
                                                <td>
...
<!--                                                <td>
                                                    <div class="flex">
                                                        <strong>R$</strong>
                                                        <input value="<?/*= (! empty($curso['avista'])) ? number_format($curso['avista'], 2, ',', '.') : '' */?>" class="valor_monetario span2 valores<?/*= $curso['idcurso'] */?>" name="valores[<?/*= $curso['idcurso'] */?>][avista]" maxlength="12" type="text">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="flex">
                                                        <strong>R$</strong>
                                                        <input value="<?/*= (! empty($curso['aprazo'])) ? number_format($curso['aprazo'], 2, ',', '.') : '' */?>" class="valor_monetario span2 valores<?/*= $curso['idcurso'] */?>" name="valores[<?/*= $curso['idcurso'] */?>][aprazo]" maxlength="12" type="text">
                                                    </div>
                                                </td>-->
                                                <td>
                                                <div class="flex">
                                                        <input
                                                            ...
                                                            class="quantidade_matriculas_1 span2 valores<?= $curso['idcurso'] ?>"
                                                ...
                                                <td>
                                                    <div class="flex">
                                                        <input
                                                                ...
                                                                class="quantidade_matriculas_2 span2 valores<?= $curso['idcurso'] ?>"
                                                ...
                                                <td>
                                                    <div class="flex">
                                                        <input
                                                            ...
                                                            maxlength="3" type="int"><strong> x</strong>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="flex">
                                                        <input
                                                            value="<?= $curso['qtd_parcelas'] ?>"
                                                            class="qtd_parcelas parcelas_max10 parcela span1 valores<?= $curso['idcurso'] ?>"
                                                            name="valores[<?= $curso['idcurso'] ?>][qtd_parcelas]"
                                                            maxlength="2" type="int"><strong> x</strong>
                                                    </div>
                                                </td>
                                                <td>
