...
<div class="container-fluid">
                ...
                <div class="tabbable tabs-left">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_editar">
                            ...
                            <br />
                            <div class="row-fluid">
                                <a href="javascript:void(0);" class="span3 botao btn" id="disponibilizarEmp"><?= $idioma['disponivel']; ?></a>
                                <a href="javascript:void(0);" class="span3 botao btn" id="indisponibilizarEmp"><?= $idioma['indisponivel']; ?></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            altualizaBotoes('<?= $linha['contratos_aceitos'];?>');
        });
    </script>
