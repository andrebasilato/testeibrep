...
//    ),
   ...
   array(
        'id' => 'em_curso',
        'variavel_lang' => 'tabela_em_curso',
        'tipo' => 'php',
        'coluna_sql' => 'em_curso',
        'valor' => 'return formataData($linha["em_curso"],"br",0);',
        'tamanho' => '80',
        'busca' => true,
        'busca_class' => 'inputPreenchimentoCompleto',
        'busca_metodo' => 4
    ...
    array(
        ...
        'variavel_lang' => 'tabela_motivo_cancelamento',
        'tipo' => 'banco',
        'coluna_sql' => 'motivo_cancelamento',
        'valor' => 'motivo_cancelamento',
        'busca' => true,
        'busca_class' => 'inputPreenchimentoCompleto',
        'busca_metodo' => 2
    ),
   array(
        'id' => 'valor_curso',
        'variavel_lang' => 'tabela_valor_curso',
        'tipo' => 'php',
        'valor' => 'if($linha["valor_cfc"] >0) {
                        return number_format($linha["valor_cfc"], 2, ",", ".");}
                    else {
                        return number_format($linha["valor_sindicato"], 2, ",", ".");}',
        'busca' => false,
    ),
    array(
        'id' => 'valor_contrato',
...
$config['formulario'] = array(
    array(
        ...
        'campos' => array(
            ...
            array(
                "id" => "form_faturada",
                "nome" => "q[1|ma.faturada]",
                "nomeidioma" => "form_faturada",
                "tipo" => "select",
                "array" => "sim_nao",
                "class" => "span1",
...
//            ),
            array(
                'id' => 'form_em_curso',
                'nome' => 'q[de_ate_em_curso|tipo_data_em_curso_filtro|mh.data_cad]',
                'tipo' => 'select',
                'array' => 'tipo_data_filtro',
                'class' => 'span3',
                'valor' => 'tipo_data_em_curso_filtro',
                'banco' => true,
                'iddiv' => 'de_em_curso',
                'iddiv2' => 'ate_em_curso',
                'iddivs' => array(
            ...
            array(
                ...
                'tipo' => 'input',
                'class' => 'span2',
                "evento" => "onchange='validaIntervaloDatasUmAno(\"form_de_em_curso\",\"form_ate_em_curso\")'",
                'nomeidioma' => 'form_de_em_curso',
                'datepicker' => true,
                'input_hidden' => true,
                'mascara' => '99/99/9999'
            )
