<?php
	...
	switch ($url[3]) {
		...
		case "html":
			...
			$relatorioObj->Set("ordem_campo","p.nome, cl.data_cad");
			$relatorioObj->Set("campos","p.idpessoa, p.nome as aluno, m.idmatricula, i.nome_abreviado as sindicato, c.nome as curso");		
