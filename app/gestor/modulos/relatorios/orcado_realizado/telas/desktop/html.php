...
<table border="1">
  ...
  <tr>
    ...
    <td align="center" bgcolor="#F4F4F4" style="text-align:center; width: 80px;"><strong>REALIZADO</strong></td>
    ...
    <td align="center" bgcolor="#FFFAD3" style="text-align:center; width: 80px;"><strong>REALIZADO</strong></td>
    ...
    <tr>
      <td align="center"><font title="Idcategoria: <?= $categoria['idcategoria']; ?>"><?= strtoupper($categoria['nome']); ?></font></td>
          <? foreach($dadosArray['sindicatos'] as $indSindicato => $sindicato) { 
			    ...
			    $total['sindicato'][$sindicato['idsindicato']]["parcelas"] += $dadosArray['contas'][$sindicato['idsindicato']][$categoria['idcategoria']]['parcelas'];
                $total['sindicato'][$sindicato['idsindicato']]["total"] += $dadosArray['contas'][$sindicato['idsindicato']][$categoria['idcategoria']]['total'];             

			    $total['categoria'][$categoria['idcategoria']]["parcelas"] += $dadosArray['contas'][$sindicato['idsindicato']][$categoria['idcategoria']]['parcelas'];
                $total['categoria'][$categoria['idcategoria']]["total"] += $dadosArray['contas'][$sindicato['idsindicato']][$categoria['idcategoria']]['total']; 
 
			    $total['geral']["parcelas"] += $dadosArray['contas'][$sindicato['idsindicato']][$categoria['idcategoria']]['parcelas'];
                $total['geral']["total"] += $dadosArray['contas'][$sindicato['idsindicato']][$categoria['idcategoria']]['total'];  
          ...
          <td align="center" bgcolor="#F4F4F4" style="text-align:center;" title="<?= (int) $dadosArray['orcamentos'][$sindicato['idsindicato']][$categoria['idcategoria']]['parcelas']; ?> Registro(s)"><? $relatorioObj->FormataValor($dadosArray['orcamentos'][$sindicato['idsindicato']][$categoria['idcategoria']]['total'], false, 9999999999); ?></td>
      	  <td align="center" style="text-align:center;" title="<?= (int) $dadosArray['contas'][$sindicato['idsindicato']][$categoria['idcategoria']]['parcelas']; ?> Registro(s)"><? $relatorioObj->FormataValor($dadosArray['contas'][$sindicato['idsindicato']][$categoria['idcategoria']]['total'], false, $dadosArray['orcamentos'][$sindicato['idsindicato']][$categoria['idcategoria']]['total']); ?></td>
          <td align="center" style="text-align:center;"><? $relatorioObj->FormataSaldo($dadosArray['orcamentos'][$sindicato['idsindicato']][$categoria['idcategoria']]['total']+$dadosArray['contas'][$sindicato['idsindicato']][$categoria['idcategoria']]['total'], false, 0); ?></td>
		  <? } ?>
