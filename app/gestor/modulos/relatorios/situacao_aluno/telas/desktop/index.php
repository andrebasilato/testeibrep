    ...
    <div class="row">
      ...
      <form method="get" action="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/html" id="formRelatorio" class="form-horizontal" target="_blank" onsubmit="return valida(this, regras)">
        ...
        <div class="form-actions">
          ...
          &nbsp;
          <?php /*<input type="submit" class="btn btn-primary" value="<?= $idioma["btn_gerar_xlsx"]; ?>" onclick="document.getElementById('formRelatorio').action = '/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/xls'">
          &nbsp;*/ ?>
...
<script type="text/javascript">
    ...
    ?>
    regras.push("required,form_de_matricula,Data de (matrícula) vazio");
    regras.push("required,form_ate_matricula,Data até (matrícula) vazio");
