...
function gerarGraficoEstadosMatriculas()
{
    $plot = new PHPlot();
...
function gerarRelatorioEstatosFaturamento(){
    $plot = new PHPlot();
...
function gerarGraficoMatriculasMetas() 
{
    $plot = new PHPlot();
...
function gerarGraficoFaturamentoMetas()
{
    $plot = new PHPlot();
...
function gerarGraficoAcumuladoMatriculas() 
{
    $plot = new PHPlot();
...
function gerarGraficoAcumuladoFaturamento() 
{
    $plot = new PHPlot();
...
function gerarGraficoMatriculasRelacaoAMeta()
{
    $plot = new PHPlot();
...
function gerarGraficoFaturamentoRelacaoAMeta()
{
    $plot = new PHPlot();
