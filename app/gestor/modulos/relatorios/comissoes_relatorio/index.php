...
if($url[3] == "html" || $url[3] == "xls"){
  $linhas = $relatorioObj->gerarRelatorio();
  //print_r2($linhas,true);
}

$linha["competencia_de"] = date("m/Y", mktime(0, 0, 0, date("m")-1, date("d"), date("Y")));
$linha["competencia_ate"] = date("m/Y", mktime(0, 0, 0, date("m"), date("d"), date("Y")));
