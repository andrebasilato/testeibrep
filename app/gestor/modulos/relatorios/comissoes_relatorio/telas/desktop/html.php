...
<head>
<title>Alfama Oráculo - Relatório de Comissões</title>
...
<? } ?>
<?php /*?><table width="100%" border="0" cellspacing="0" cellpadding="10">
  <tr>
    <td>Registros encontrados: <?= count($dadosArray); ?></td>
  </tr>
</table><?php */?>
<?php $relatorioObj->GerarTabela($linhas,$_GET,$idioma); ?>
