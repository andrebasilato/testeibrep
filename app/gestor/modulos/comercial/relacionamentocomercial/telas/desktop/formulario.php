      		...
      		<? if(count($salvar["erros"]) > 0){ ?>
      			<div class="alert alert-error fade in">
                    <a href="javascript:void(0);" class="close" data-dismiss="alert">×</a>
                      ...
                      <?php //print_r2($salvar["erros"]);exit(); ?>
                          <? foreach($salvar["erros"] as $ind => $val) { 
                                if ($val == 'erro_email_utilizado') { ?>
                                    <br />
                                    <?= $idioma['email_utilizado'] ?>
                                    <a class="btn btn-mini" href="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/<?= $salvar['idrelacionamento'] ?>/administrar">Abrir Relacionamento</a>
                                <?php } else { ?>
                                    <br />
                                    <?php echo $idioma[$val]; ?>
                                <?php } ?>
