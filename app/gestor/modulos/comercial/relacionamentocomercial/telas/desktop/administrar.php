            ...
            <legend><?= $idioma["label_relacionamento"]; ?></legend>
              <div class="accordion" id="accordion_mensagens"> 
                <div class="accordion-group">
                  <div class="accordion-heading" style="background-color: #D4FFC0; font-weight:bold">
                    ...
                    <div class="accordion-inner">
                      <form name="form_mensagens" method="post" onsubmit="return validaMensagem();" id="form_mensagens" >
                          <input type="hidden" name="idrelacionamento" id="idrelacionamento" value="<?php echo $url[3];?>" >
                            <strong><?= $idioma['mensagem_texto'] ?></strong><br>
                            <textarea name="mensagem" id="mensagem" rows="5" style="width:60%;"></textarea>
              ...
              <div class="mensagens">
                ...
                <?php if (($mensagem["idusuario"] == $usuario["idusuario"]) && ($count == 1)) { ?>
                    <span class="mensagens-remover"><a class="btn btn-mini" href="javascript:void(0);" onclick="removerMensagem(<?= $mensagem["idmensagem"]; ?>);" ><span class="icon-remove"></span> <?php echo $idioma["mensagem_excluir"]; ?></a></span>
                <?php } ?>
