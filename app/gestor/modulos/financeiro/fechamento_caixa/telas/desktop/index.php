...
<div class="container-fluid">
                ...
                <div id="listagem_informacoes">
                    ...
                    <? if ($linhaObj->verificaPermissao($perfil["permissoes"], $url[2] . "|2", NULL)) { ?>
                        <span class="pull-right" style="padding-top:3px; color:#999">
                            <a href="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/cadastrar" class="btn btn-primary"><i class="icon-plus icon-white"></i> <?= $idioma["nav_novousuario"]; ?></a>
                          </span>
                        <span class="pull-right" style="padding-top:3px; color:#999">
                    ...
                    <div class="input">
                        <div class="inline-inputs"> <?= $idioma["registros"]; ?>
                            <form action="" method="get" id="formQtd">
                                ...
                                <a href="" class="btn small">Exportar</a>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <script language="javascript" type="text/javascript">
        jQuery(document).ready(function ($) {
            ...
            $("input[name='q[3|fc.data_cad]']").datepicker($.datepicker.regional["pt-BR"]);
            $("input[name='q[3|fc.data_cad]']").mask('99/99/9999');
        });
    </script>
</div>
</body>
