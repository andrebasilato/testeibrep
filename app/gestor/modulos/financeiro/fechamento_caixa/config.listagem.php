...
$config["listagem"] = array(
    ...
    array("id"            => "opcoes",
          ...
          "tipo"          => "php",
          "valor"         => 'return "<a target=\"_blank\" class=\"btn dropdown-toggle btn-mini\"  href=\"/".$this->url["0"]."/relatorios/fechamento_caixa_relatorio/html/?q[1|fc.idfechamento]=".$linha["idfechamento"]."\" >".$idioma["tabela_visualiza"]."</a>&nbsp;<a href=\"/".$this->url["0"]."/financeiro/fechamento_caixa/".$linha["idfechamento"]."/xml\" target=\"_blank\" class=\"btn dropdown-toggle btn-mini\">XML</a>"',
          "busca_botao"   => true,
          "tamanho"       => "130")
