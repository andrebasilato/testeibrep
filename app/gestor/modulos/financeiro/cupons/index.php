<?php
include("../classes/cupons.class.php");
include("config.php");
        ...
        if ($linha) {
            switch ($url[4]) {
                ...
                case "cfc":
                    ...
                    $linhaObj->Set("campos", "cp.idcupom_escola, cp.idcupom, p.idescola, p.nome_fantasia");
                ...
                case "cursos":
                    ...
                    $linhaObj->Set("campos", "cc.idcupom_curso, cc.idcupom, c.idcurso, c.nome");
                ...
                /*case "visualizarsindicatos":
                    ...
                    $linhaObj->Set("campos", "ci.idcupom_sindicato, ci.idcupom, i.idsindicato, i.nome_abreviado");
