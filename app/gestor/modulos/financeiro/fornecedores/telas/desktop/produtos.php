...
<div class="container-fluid">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_editar">
                            ...
                            <form class="well" method="post">
                                <p><?= $idioma["form_produto"]; ?></p>
                                <?php if ($perfil["permissoes"][$url[2] . "|5"]) { ?>
                                    <select id="produtos" name="produtos"></select>
                                    <br/>
                                    <br/>
                                    <input type="hidden" id="acao" name="acao" value="associar_produto">
                                    <input type="submit" class="btn" value="<?= $idioma["btn_adicionar"]; ?>"/>
                                <?php } else { ?>
                                    <select id="produtos" name="produtos" disabled="disabled"></select>
                                    <br/>
                                    <br/>
                            ...
                            <form method="post" id="remover_produto" name="remover_produto">
                                <input type="hidden" id="acao" name="acao" value="remover_produto">
                                            ...
                                            <td>
                                                <?php if ($perfil["permissoes"][$url[2] . "|6"]) { ?>
                                                    <a href="javascript:void(0);" class="btn btn-mini"
                                                       ...
                                                       onclick="remover(<?php echo $produto["idproduto_fornecedor"]; ?>)"><i
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#produtos").fcbkcomplete({
                json_url: "/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/<?= $url[3]; ?>/json/associar_produtos",
                addontab: true,
                height: 10,
                maxshownitems: 10,
                cache: true,
        ...
        function remover(id) {
            ...
            if (confirma) {
                ...
                document.getElementById("remover_produto").submit();
            }
        }
    </script>
</div>
