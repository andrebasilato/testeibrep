<?php
include("../classes/cartoes.class.php");
include("config.php");
...
if ($_POST["acao"] == "salvar") {
    ...
    if ($salvar["sucesso"]) {
        ...
        $_POST['bandeiras'] = serialize($_POST['bandeiras']);
        $_POST['formas_pagamento'] = serialize($_POST['formas_pagamento']);
    }
...
if (isset($url[3])) {
        ...
        if ($linha) {
            switch ($url[4]) {
                ...
                case "sindicatos":
                    ...
                    $linhaObj->Set("campos", "ci.idcartao_sindicato, ci.idcartao, i.idsindicato, i.nome_abreviado");
    ...
    $linhaObj->Set("campos", "*, (SELECT COUNT(*) FROM cartoes_sindicatos ci WHERE ci.idcartao = cartoes.idcartao AND ci.ativo = 'S') as sindicatos");
