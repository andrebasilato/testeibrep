  ...
  <div class="row-fluid">
  	<div class="span12">
        <div class="box-conteudo">
                ...
                <? if($linhaObj->verificaPermissao($perfil["permissoes"], $url[2]."|1", NULL)){ ?>
                         <a href="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/cadastrar" class="btn btn-primary"><i class="icon-plus icon-white"></i> <?= $idioma["nav_novoretorno"]; ?></a>
...
<script language="javascript" type="text/javascript">
  jQuery(document).ready(function($) {
	...
	$("input[name='q[3|cp.data_cad]']").mask("99/99/9999");
	$("input[name='q[3|cp.data_cad]']").datepicker($.datepicker.regional["pt-BR"]);
  });
</script>
</div>
</body>
