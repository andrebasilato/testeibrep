    ...
    <td align="right" valign="top">
      <table border="0" align="right" cellpadding="3" cellspacing="0" class="impressao">
        <tr>
          ...
          <td>
			<?php /*?><a class="btn" href="#link_salvar" rel="facebox" ><?php echo $idioma['salvar_relatorio'] ?></a>
          ...
          <td>
			<?php /*?><form method="post" action="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/xls?<?php echo $_SERVER["QUERY_STRING"]; ?>">  
...
<?php $linhaObj->GerarTabela($dadosArray,$_GET["q"],$idioma,'listagemRelatorioPagamentos'); ?>
