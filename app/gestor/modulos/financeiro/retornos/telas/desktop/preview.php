        ...
        <div class="box-conteudo">
            ...
            <div class="tab-content">
      		...
      		<form method="post" onsubmit="return validateFields(this, regras)" enctype="multipart/form-data" class="form-horizontal">
        		...
        		<input name="acao" type="hidden" value="processar" /><br><br>
                        <table width="100%" border="0" cellspacing="0" cellpadding="10">
                          <tr>
                            <td><?=$idioma["registros"]?> <?= count($dadosArray); ?></td>
                          </tr>
                        </table>
        		...
        		<? if($url[4] == "editar") {
					...
					$linhaObj->GerarTabelaParcelas($dadosArray,$_GET["q"],$idioma,'listagemRelatorioPreview'); 
