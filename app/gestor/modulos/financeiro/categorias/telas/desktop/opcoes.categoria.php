<section id="global">
    ...
    <ul class="breadcrumb">
        <li><? echo $idioma["categoria_selecionada"]; ?></li>
    ...
    <ul class="nav nav-tabs nav-stacked">
        ...
        <li>
            <? if ($linhaObj->verificaPermissao($perfil["permissoes"], $url[2] . "|2", NULL)) { ?>
                <a href="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/<?php echo $linha["idcategoria"]; ?>/editarcategoria">
        ...
        <li>
            <? if ($linhaObj->verificaPermissao($perfil["permissoes"], $url[2] . "|3", NULL)) { ?>
                <a href="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/<?php echo $linha["idcategoria"]; ?>/removercategoria">
