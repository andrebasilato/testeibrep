    ...
    <div class="row-fluid">
        ...
        <span class="pull-right" style="padding-top:3px; color:#999">        
     	<? if ($linhaObj->verificaPermissao($perfil["permissoes"], $url[2] . "|2", NULL)) { ?>
                ...
                <a href="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/cadastrarcategoria" class="btn btn-primary"><i class="icon-plus icon-white"></i> <?= $idioma["nav_novacategoria"]; ?></a>
        <? } ?>
            <? if ($linhaObj->verificaPermissao($perfil["permissoes"], $url[2] . "|2", NULL)) { ?>
                 <a href="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/cadastrarsubcategoria" class="btn btn-primary"><i class="icon-plus icon-white"></i> <?= $idioma["nav_novasubcategoria"]; ?></a>
            <? } ?>
        </span>
