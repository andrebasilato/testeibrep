...
<div class="container-fluid">
              ...
              <div class="tab-pane active" id="tab_editar">
                ...
                <form method="post" onsubmit="return validateFields(this, regras)" enctype="multipart/form-data"
                    ...
                    <? if ($url[4] == "editarsubcategoria") {
                        ...
                        $linhaObj->GerarFormulario("formulario_subcategoria", $linha, $idioma);

                    } else {
                        $linhaObj->GerarFormulario("formulario_subcategoria", $_POST, $idioma);
                    }
                    ?>
    ...
    <script type="text/javascript">
        ...
        <?php
        foreach($config["formulario_subcategoria"] as $fieldsetid => $fieldset) {
