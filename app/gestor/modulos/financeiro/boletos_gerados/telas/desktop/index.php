...
<div class="container-fluid">
    ...
    <script language="javascript" type="text/javascript">
        jQuery(document).ready(function ($) {
			...
			$("input[name='q[1|c.idconta]']").keypress(isNumber);
            $("input[name='q[1|c.idconta]']").blur(isNumberCopy);
  			
			$("input[name='q[1|c.idmatricula]']").keypress(isNumber);
            $("input[name='q[1|c.idmatricula]']").blur(isNumberCopy);
  			
			$("input[name='q[4|c.valor]']").maskMoney({symbol:"R$",decimal:",",thousands:"."});
            $("input[name='q[3|data_vencimento]']").mask("99/99/9999");
