                ...
                <div class="tabbable tabs-left">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_editar">
                            ...
                            <form method="post" id="remover_associacao_sindicato"
                                  name="remover_associacao_sindicato">
                            ...
                            <table class="table table-striped tabelaSemTamanho">
                                ...
                                <?php if (count($associacoesArray) > 0) { ?>
                                    <?php foreach ($associacoesArray as $ind => $associacao) { ?>
                                        <tr>
                                            <td><?= $associacao["idconta_corrente_sindicato"]; ?></td>
                                            <td><?= $associacao["nome_abreviado"]; ?></td>
                                            <td>
                                                <?php if ($perfil["permissoes"][$url[2] . "|6"]) { ?>
                                                    <a href="javascript:void(0);" class="btn btn-mini"
                                                       ...
                                                       onclick="remover(<?= $associacao["idconta_corrente_sindicato"]; ?>)"><i
