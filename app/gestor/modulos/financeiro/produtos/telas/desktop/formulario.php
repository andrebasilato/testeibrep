    ...
    <section id="global">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>"><?= $idioma["pagina_titulo"]; ?></a> <span
                    class="divider">/</span></li>
            <? if ($url[3] == "cadastrar" || $url[3] == "verificar") { ?>
    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="box-conteudo">
                ...
                <?php if ($url[3] != "cadastrar" && $url[3] != "verificar") { ?><h2
                    class="tituloEdicao"><?php echo $linha["nome"]; ?></h2><?php } ?>
                <div class="tabbable tabs-left">
                    <?php if ($url[3] != "cadastrar" && $url[3] != "verificar") {
                        incluirTela("inc_menu_edicao", $config, $linha);
                    } ?>
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_editar">
                            <h2 class="tituloOpcao"><?php if ($url[3] == "cadastrar" || $url[3] == "verificar") {
