                ...
                <div class="tabbable tabs-left">
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_editar">
                            ...
                            <? } ?>
                            <form class="well" action="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/administrar/"
                                  method="post" id="form_matricula" name="form_matricula" onsubmit="return Seturl();">
                                ...
                                <?php if ($perfil["permissoes"][$url[2] . "|2"]) { ?>
                                    ...
                                    <input type="submit" class="btn btn-primary" name="enviar"
                                           value="<?php echo $idioma["btn_abrir_ficha"]; ?> "/>
                                ...
                                <?php } else { ?>
                                    ...
                                    <a href="javascript:void(0);" rel="tooltip"
                                       ...
                                       class="btn disabled"><?= $idioma["btn_abrir_ficha"]; ?></a>
                                <?php } ?>
                                <br/><br/>
                            </form>
