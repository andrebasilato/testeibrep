    ...
    $config["listagem"] = array(
        ...
        array(
            ...
            "evento" => "maxlength='100'",
            "coluna_sql" => "frd.nome",
            "valor" => 'if($linha["clone"]){
                            $clone = "";
                            if(strlen($linha["clone"]) > 15){
                                $quantidade = strlen($linha["clone"]) - 15;
                                $clone = substr($linha["clone"], $quantidade, 17);
                            } else {
                            $clone = $linha["clone"];
                            }
                            return $linha["nome"] . " - " . "<span data-original-title=\"".$linha["clone"]."\" class=\"label label-success\" data-placement=\"left\" rel=\"tooltip\">$clone</span>";
                            } else {
                            return $linha["nome"];
                            }',
            "busca" => true,
