    ...
    <form method="post">
        <table width="100%" border="1" cellpadding="8" cellspacing="0">
            <tr>
                ...
                <td bgcolor="#F4F4F4" width="10%"><strong><?php echo $idioma["cfc_aluno"]; ?></strong></td>
                ...
                <td bgcolor="#F4F4F4" width="10%"><strong><?php echo $idioma["numero_oficio"]; ?></strong></td>
            ...
            foreach($matriculas as $matricula) {
                ...
                <tr>
                    ...
                    <td><?php echo $matricula['escola']; ?></td>
                    <td><?php echo $registro; ?></td>
                    <td><?php echo $_POST['numero_relacao']; ?></td>
                    <td><?php echo $_POST['numero_oficio']; ?></td>
                    ...
                    <td>
                        ...
                        <input type="hidden" name="matriculas[<?= $ind_mat; ?>][cfc_aluno]" value="<?= $matricula['escola'] ?>" />
                        ...
                        <input type="hidden" name="matriculas[<?= $ind_mat; ?>][numero_oficio]" value="<?= $_POST['numero_oficio'] ?>" />
        ...
        <input type="hidden" name="numero_oficio" value="<?= $_POST['numero_oficio'] ?>" />
    ...
    foreach($matriculas as $matricula) {
		...
		<table width="100%" border="1" cellpadding="8" cellspacing="0">
			<tr>
				...
				<td bgcolor="#F4F4F4" width="10%"><strong><?= $idioma['documento'] ?></strong></td>
                ...
                <td bgcolor="#F4F4F4" width="10%"><strong><?= $idioma["numero_oficio"]; ?></strong></td>
        ...
        <tr>
            ...
            <td class="linha" width="10%"><?php echo mascara($matricula['documento'], '###.###.###-##'); ?></td>
            <td class="linha" width="10%"><?php echo $info['numero_registro']; ?></td>
            <td class="linha" width="10%"><?php echo $matricula['numero_relacao']; ?></td>
            <td class="linha" width="10%"><?php echo $matricula['numero_oficio']; ?></td>
