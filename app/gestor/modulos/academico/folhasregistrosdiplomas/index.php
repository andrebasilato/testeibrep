...
/** Configurations */
$noEditableFields = array('idsindicato', 'numero_ordem', 'numero_relacao', 'numero_registro');
...
if (Request::post('acao')) {
    $salvar = $linhaObj->doAction(Request::post('acao'));
}
...
if (Request::url(4)) {
        ...
        if ($linha) {
            switch ($url[4]) {
                case  "abrir_folhas_pdf":
                    ...
                    $linhaObj->set("campos", "frdm.*, mat.*, pes.rg as rg, mat.data_expedicao as data_expedicao, frd.numero_relacao, frd.numero_oficio, pes.nome as pessoa, ofe.nome as oferta, cur.nome as curso, pol.nome_fantasia as escola, tur.nome as turma, c.*");
                ...
                case "ficha":
                    ...
                    $linhaObj->set("campos", "frdm.*, mat.*, pes.rg as rg, pes.documento, mat.data_expedicao as data_expedicao, frd.numero_relacao, frd.numero_oficio, pes.nome as pessoa, ofe.nome as oferta, cur.nome as curso, pol.nome_fantasia as escola, tur.nome as turma, c.*");
                    $matriculas = $linhaObj->retornarDiplomas();
                ...
                case "editar":
                    ...
                    $qntMatriculas = $linhaObj->retornarTotalMatriculasDaFolha($linha['idfolha']);
                    ...
                    $config['formulario'] = $linhaObj->inserirAtributos(
                        $config['formulario'],
                        $arrayAlterar,
                        $atributos
                    );
                ...
                case "diplomas":                    
                    ...
                    if ($url[5]) {
                        ...
                        switch ($url[6]) {
                            ...
                            case "gerar":
                                ...
                                $paginas = $certificado->set('idusuario', $usuario['idusuario'])->gerarCertificado($url[5], new Matriculas);
                        ...
                        $linhaObj->set("limite", -1);
                        $linhaObj->set("ordem_campo", ($_GET['cmp']) ? $_GET['cmp'] : "frdm.numero_ordem");
                        $linhaObj->set("campos", "frdm.numero_ordem, frdm.idfolha_matricula, mat.idmatricula, pes.nome as pessoa, pes.rg as rg, frdm.numero_registro, frd.numero_relacao, frdm.cancelado");
                    ...
                    break;
                case "remover":
                    $ofertas = $linhaObj->temOferta($url[3]);
    ...
    $dadosArray = $linhaObj->set("ordem_campo", $_GET["cmp"])
        ->set("campos", "frd.*, nome_abreviado as sindicato, ci.idcurso_sindicato, c.nome as curso")
