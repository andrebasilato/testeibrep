                        ...
                        <tr>
                          ...
                          <td>
                            <?php if($perfil["permissoes"][$url[2]."|6"]) { ?>
                              <a href="javascript:void(0);" class="btn btn-mini" data-original-title="<?= $idioma["btn_remover"]; ?>" data-placement="left" rel="tooltip" onclick="remover(<?php echo $sindicato["iddeclaracao_sindicato"]; ?>)"><i class="icon-remove"></i></a>
                            <?php } else { ?>
