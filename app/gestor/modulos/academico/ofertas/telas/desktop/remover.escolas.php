  ...
  <div class="container-fluid">
    <section id="global">
      ...
      <ul class="breadcrumb">
        ...
        <li><a href="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/<?= $linha["idoferta"]; ?>/cfc"><?= $idioma["pagina_titulo_interno"]; ?></a> <span class="divider">/</span></li>
        <li><?php echo $linha["escola"]; ?> <span class="divider">/</span></li>
			...
			<div class="ava-conteudo">
              ...
              <div class="tab-pane active" id="tab_editar">
                        ...
                        <div class="cabecalho-subsecao">
                        	<div class=" pull-right"><a href="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/<?= $url[3]; ?>/<?= $url[4]; ?>" class="btn btn-mini"> <?= $idioma["btn_sair_escola"]; ?> <i class="icon-remove"></i></a></div>
                      		<small><?= $idioma["voce_esta_no_escola"]; ?></small>
    						<h4 class="tituloEdicao" style="padding-left:0px;"><?= $linha["escola"]; ?> </h4>
                            <?php //include("inc_submenu_escolas.php"); ?>
                ...
                <form method="post" action="" class="form-horizontal">
                  <input name="acao" type="hidden" value="remover_escola" />
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <label class="checkbox">
                        <input name="remover" value="<?= $linha[$config["banco_escolas"]["primaria"]]; ?>" type="checkbox" id="remover">
