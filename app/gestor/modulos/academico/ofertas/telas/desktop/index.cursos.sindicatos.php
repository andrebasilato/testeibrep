          ...
          <div class="tabbable tabs-left">
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab_editar">
					...
					<br />
					<form method="post">
						<input type="hidden" name="acao" value="salvar_cursos_sindicatos" />
						...
						foreach ($dadosArray as $idsindicato => $sindicato) { ?>
							...
							<table class="table tabelaSemTamanho">
								...
								?>
									...
									<tr>
										<td>
											<?php echo $curso['curso_sindicato']['curso']; ?>										
										</td>
										<?php/*<td>
											<?php echo $curso['curso_sindicato']['sindicato']; ?>
										</td>*/?>
										<td>
											<input class="span1 numerico" type="text" name="sindicatos[<?php echo $idsindicato; ?>][cursos][<?php echo $curso['curso_sindicato']['idcurso']; ?>][limite]" value="<?php echo $curso['curso_sindicato']['limite']; ?>" />
										</td>
									</tr>
