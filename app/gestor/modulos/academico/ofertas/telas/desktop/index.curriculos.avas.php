          ...
          <div class="tabbable tabs-left">
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab_editar">
                    ...
                    <br />
                    <form method="post">
                        <input type="hidden" name="acao" value="salvar_curriculos_avas" />

                        <?php //print_r2($dadosArray);
                        foreach ($dadosArray as $idcurriculo => $curriculo) { ?>

                            <h4 class="tituloOpcao"><?php echo $curriculo["curriculo"]; ?></h4>
                            <h5><?php echo $curriculo["curso"]; ?></h5>
                            <table class="table tabelaSemTamanho">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <select class="select-sel" name="curriculos[<?php echo $idcurriculo; ?>][disciplinas][<?php echo $disciplina['iddisciplina']; ?>][idava]">
                                                <option value=""></option>
                                                <?php foreach($disciplina['avas'] as $ava) { ?>
                                                    <option value="<?php echo $ava['idava']; ?>" <?php if($disciplina['idava'] == $ava['idava']) { ?> selected="selected" <?php } ?> >
                                                        <?php echo $ava['nome']; ?>
                                                    </option>
                                                <?php } ?>
                                            </select>
