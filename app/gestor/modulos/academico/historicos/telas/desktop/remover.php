              ...
              <div class="tab-pane active" id="tab_editar">        
                ...
                <form method="post" action="" class="form-horizontal">
                  ...
                  <label class="control-label" for="optionsCheckboxList"><?= $idioma["confirmacao"]; ?></label>
                    <div class="controls">
                      <label class="checkbox">
                        <input id="enviar" name="remover" value="<?= $linha[$config["banco"]["primaria"]]; ?>" type="checkbox" id="remover">
                  ...
                  <div class="form-actions">
                    ...
                    <button type="reset" class="btn" onclick="MM_goToURL('parent','/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/<?= $url[3]; ?>/paginas');"><?= $idioma["cancelar"]; ?></button>
                  </div>
                </form>
              </div>
            </div>
