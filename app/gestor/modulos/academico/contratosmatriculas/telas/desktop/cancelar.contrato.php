...
<section id="global">
  ...
  <form id="form_contrato_cancelar" action="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>" method="post" target="_parent" >
    <input name="acao" type="hidden" value="cancelar_contrato" />
    <input name="idmatricula" id="idmatricula_cancelar" type="hidden" value="<?= $_GET['m']; ?>" />
    <input name="idmatricula_contrato" id="idmatricula_contrato_cancelar" type="hidden" value="<?= $_GET['c']; ?>" />
