...
$idioma["usuario_selecionado"] = "Modelo de prova selecionado: <strong> %s (%s)</strong>";
$idioma["informacoes"] = "Marque o campo abaixo caso queira remover as informações.";
$idioma["confirmacao"] = "Confirmação:";
$idioma["confirmacao_formulario"] = "Desejo remover as informações do modelo de prova.";
