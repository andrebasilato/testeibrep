  ...
  <div class="row-fluid">
    ...
    <script type="text/javascript">
      ...
      jQuery(function($){		
        ...
        /*if ($('#form_ativo_painel').val() == 'N') {
            $("#form_exibir_aluno").prop('disabled', true);
        }
            $('#form_ativo_painel').change(function() {
                if ($(this).val() == 'N') {
                    $('#form_exibir_aluno').val("N");
                    $("#form_exibir_aluno").prop('disabled', true);
                } else {
                    $("#form_exibir_aluno").prop('disabled', false);
                }
            });		
      });*/
