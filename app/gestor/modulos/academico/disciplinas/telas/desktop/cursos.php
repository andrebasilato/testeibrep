                            ...
                            <table class="table table-striped tabelaSemTamanho">
        						...
        						<tbody>
                                    <?php if(count($cursos) > 0) { ?>
										<?php foreach($cursos as $associacao) { ?>
                                            <tr>                                                
                                                <td><?php echo $associacao["nome"]; ?></td>
                                                <td>
                                                  <?php if($perfil["permissoes"][$url[2]."|6"]) { ?>
                                                  <a href="javascript:void(0);" class="btn btn-mini" data-original-title="<?= $idioma["btn_remover"]; ?>" data-placement="left" rel="tooltip" onclick="remover(<?php echo $associacao["iddisciplina_curso"]; ?>)"><i class="icon-remove"></i></a>
                                                  <?php } else { ?>
