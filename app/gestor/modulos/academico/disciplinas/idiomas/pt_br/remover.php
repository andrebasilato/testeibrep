...
$idioma["usuario_selecionado"] = "Disciplina selecionada: <strong> %s (%s)</strong>";
$idioma["informacoes"] = "Marque o campo abaixo caso queira remover as informações.";
$idioma["confirmacao"] = "Confirmação:";
$idioma["confirmacao_formulario"] = "Desejo remover as informações da disciplina selecionada.";
