    ...
    <div class="row-fluid">
      <div class="span12">
        <div class="box-conteudo">
          ...
          <h2 class="tituloEdicao"><?= tamanhoTexto(100,$linha["nome"]); ?></h2>
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab_editar">        
                ...
                <?php if ($possueProva) { ?>
                    <div class="alert alert-error fade in">
                        <a href="javascript:void(0);" class="close" data-dismiss="alert">×</a>
                          <?php echo $idioma['impossivel_excluir_perguntas']; ?>
                    </div>
                <?php } ?>   
                <form method="post" action="" class="form-horizontal">
                  <input name="acao" type="hidden" value="removerpergunta" />
                  <div class="control-group">
                  <p> 
                    <? printf($idioma["usuario_selecionado"],tamanhoTexto(100,$linha["nome"]), $linha[$config["banco"]["primaria"]]); ?>
                    <br />
                    <br />
