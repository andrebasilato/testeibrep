...
$config['form_listaa'] = array(
    ...
    array(
        ...
        'busca_metodo' => 2,
        'busca_class' => 'span4',
        'variavel_lang' => 'tabela_nome_do_arquivo',
    ...
    array(
        ...
        "valor" => 'return "<!--a class=\"btn dropdown-toggle btn-mini\" ' .
            ...
            <div class=\"image\">
                <button type=\"button\" class=\"btn btn-mini useImage\" data-url=\"/storage/discovirtual/".$linha["idava"]."/".$linha["idpasta"]."/".$linha["nome_no_disco"]."\">Inserir</button>
...
try {
    ...
    require 'telas/'.$config['tela_padrao'].'/index.conteudos.editor.discovirtual.php';
