          ...
          <div class="tabbable tabs-left">
            ...
            <div class="ava-conteudo"> 
              ...
              <div class="tab-pane active" id="tab_editar">
                ...
                <div class="alert alert-error fade in">
                    <a href="javascript:void(0);" class="close" data-dismiss="alert">×</a>
                      <?php echo $idioma['impossivel_excluir_avaliacao']; ?>
                </div>
                <?php } ?>  
                <form method="post" action="" class="form-horizontal">
                  <input name="acao" type="hidden" value="remover_avaliacao" />
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <label class="checkbox">
                        <input name="remover" value="<?= $linha[$config["banco_avaliacoes"]["primaria"]]; ?>" type="checkbox" id="remover">
