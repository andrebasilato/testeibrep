...
<div style="padding-top:15px; padding-bottom:15px;">
  ...
  <a class="menu <?php if($url[6] == "linksacoes") { echo "ativo"; } else { echo "inativo"; } ?>" href="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/<?= $url[3]; ?>/<?= $url[4]; ?>/<?= $url[5]; ?>/linksacoes"><?php echo $idioma["menu_linksacoes"]; ?></a>
