  ...
  <div class="container-fluid">
    <section id="global">
      ...
      <ul class="breadcrumb">
        ...
        <li><a href="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/<?= $linha["idava"]; ?>/downloads"><?= $idioma["pagina_titulo_interno"]; ?></a> <span class="divider">/</span></li>
            ...
            <div class="ava-conteudo"> 
              ...
              <div class="tab-pane active" id="tab_editar">
                ...
                <form method="post" action="" class="form-horizontal">
                  <input name="acao" type="hidden" value="remover_download" />
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <label class="checkbox">
                        <input name="remover" value="<?= $linha[$config["banco_downloads"]["primaria"]]; ?>" type="checkbox" id="remover">
