            ...
            <div class="ava-conteudo"> 
              ...
              <div class="tab-pane active" id="tab_editar">
                ...
                <div id="listagem_informacoes"> 		  
                  ...
                  <? if($linhaObj->verificaPermissao($perfil["permissoes"], $url[2]."|35", NULL)){ ?>
                    <span class="pull-right" style="padding-top:3px; color:#999">
                      <a href="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/<?= $url[3]; ?>/<?= $url[4]; ?>/cadastrar" class="btn primary"><?= $idioma["nav_cadastrar"]; ?></a>
                    </span>
                  <? } ?>					
                </div>
                <?php $linhaObj->GerarTabela($dadosArray,$_GET["q"],$idioma,"listagem_tira_duvidas"); ?>
