...
<head>
    ...
    <link href="/assets/plugins/fancybox/source/jquery.fancybox.css?v=2.1.5" rel="stylesheet" type="text/css" media="screen" />
</head>
<style media>
    .btn {
    ...
    .screen .toolbar {
        background: url(/assets/plugins/ibrepbuilder/elements/images/bg-cima.png) no-repeat !important;
    ...
    .screen .frameWrapper {
        ...
        max-width: 718.2px !important;
        margin-top: -505px !important;
        margin-left: 118px !important;
        outline: 26px solid #fff !important;
        box-shadow: 0px 0px 10px 27px #fff !important;
    }
    
    @media (max-width: 992px) {
        .screen .toolbar {
            background: url(/assets/plugins/ibrepbuilder/elements/images/bg-768.PNG) no-repeat !important;
            width: 768px !important;
        }
        .screen .frameWrapper {
            max-width: 587px !important;
            box-shadow: 0px 0px 5px 43px #fff !important;
            outline: 40px solid #fff !important;
    ...
    .tablet .toolbar {
        background: url(/assets/plugins/ibrepbuilder/elements/images/bg-tablet1.PNG) no-repeat !important;
        width: 943px !important;
        margin-left: -160px;
    }

    .mobile .toolbar {
        background: url(/assets/plugins/ibrepbuilder/elements/images/bg-mobile1.PNG) no-repeat !important;
    ...
    .mobile .frameWrapper {
        ...
        box-shadow: 0px 0px 10px 19px #fff !important;
    }

    .tablet .frameWrapper {
        max-width: 555px !important;
        margin-left: -50px !important;
        outline: 17px solid #fff !important;
        box-shadow: 0px 0px 10px 22px #fff !important;
    }
...
<body style="display: none">
    ...
    <div id="builder">
        ...
        <div class="menu" id="menu">
            <div class="main" id="main">
                ...
                <h3>
                    <span class="fui-list"></span> Blocos
                </h3>
                ...
                <h3>
                    <span class="fui-windows"></span> Conteúdo
                </h3>
        ...
        <div class="container">
            ...
            <header class="clearfix affix">
                ...
                <a href="#" id="savePage" data-toggle="modal" class="btn btn-primary btn-embossed pull-right actionButtons">
                    <i class="fui-check"></i>
                    <span class="bLabel">Nada para salvar</span></a>
            ...
            <div class="screen" id="screen">
                ...
                <div id="frameWrapper" class="frameWrapper empty">
                    ...
                    <div class="start" id="start" style="display:none">
                        <span>CONSTRUA SEU CONTEÚDO ARRASTANDO BLOCOS PARA A TELA</span>
                    </div>
                </div>
        ...
        <div id="styleEditor" class="styleEditor">
            ...
            <h3><span class="fui-new"></span> Editor de detalhe</h3>
            ...
            <ul class="nav nav-tabs" id="detailTabs">
                <li class="active">
                    <a href="#tab1">
                        <span class="fui-new"></span> Estilo
                    </a>
                </li>
                ...
                <li style="display: none;">
                    <a href="#image_Tab" id="img_Link">
                        <span class="fui-image"></span> Imagem
                    </a>
                </li>
                <li style="display: none;">
                    <a href="#icon_Tab" id="icon_Link">
                        <span class="fa fa-flag"></span> Ícone
                    </a>
                </li>
                <li style="display: none;">
                    <a href="#video_Tab" id="video_Link">
                        <span class="fa fa-youtube-play"></span> Vídeo
                    </a>
                </li>
                <li style="display: none;">
                    <a href="#audio_Tab" id="audio_Link">
                        <span class="fa fa-file-audio-o"></span> Áudio
                    </a>
                </li>
            </ul><!-- /tabs -->
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane imageFileTab" id="image_Tab">
                    <a href="#imageModal" data-toggle="modal" type="button" class="btn btn-default btn-embossed btn-block margin-bottom-20"><span class="fui-image"></span> Abrir galeria</a>
                </div><!-- /.tab-pane -->
                ...
                <div class="tab-pane videoTab" id="video_Tab">
                    <a href="#videoModal" data-toggle="modal" type="button" class="btn btn-default btn-embossed btn-block margin-bottom-20"><span class="fa fa-youtube-play"></span> Abrir videoteca</a>
                    
                    <label>ID do Youtube:</label>
                        
                    <input type="text" class="form-control margin-bottom-20" id="youtubeID" placeholder="ID de um vídeo do YouTube" value="">
                    ...
                    <input type="text" class="form-control margin-bottom-20" id="vimeoID" placeholder="ID de um vídeo do Vimeo" value="">

                    <p class="text-center or">
                        <span>ou</span>
                    </p>
                        
                    <label>ID do Video Interno:</label>
                        
                    <input type="text" class="form-control margin-bottom-20" id="videoID" placeholder="ID de um vídeo Interno" value="">
                        
                </div>

                <div class="tab-pane audioTab" id="audio_Tab">
                    <a href="#audioModal" data-toggle="modal" type="button" class="btn btn-default btn-embossed btn-block margin-bottom-20"><span class="fa fa-youtube-play"></span> Abrir biblioteca de áudios</a>
            ...
            <div class="margin-bottom-5">
                <button type="button" class="btn btn-primary btn-embossed btn-sm btn-block" id="saveStyling"><span class="fui-check-inverted"></span> Aplicar Mudanças</button>
            </div>

            <div class="sideButtons clearfix">
                <button type="button" class="btn btn-inverse btn-embossed btn-xs" id="cloneElementButton">
                    <span class="fui-windows"></span> Clonar
                </button>
                ...
                <button type="button" class="btn btn-danger btn-embossed btn-xs" data-target="#deleteElement" data-toggle="modal" id="removeElementButton">
                    <span class="fui-cross-inverted"></span> Remover
                </button>
            </div>
        ...
        <div id="hidden">
            <iframe src="/assets/plugins/ibrepbuilder/elements/skeleton.html" id="skeleton"></iframe>
        </div>
    ...
    <div class="modal fade imageModal" id="imageModal" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-dialog" style="width: 1000px; display: block; margin: 0 auto;">
            <div class="modal-content" id="imageModalContent">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Fechar</span></button>
                    <h4 class="modal-title" id="myModalLabel"><span class="fui-upload"></span> Disco Virtual</h4>
                </div>
                <div class="modal-body">
                                        
                    <iframe id="disco" src="/<? echo $url[0].'/'.$url[1].'/'.$url[2].'/'.$url[3];?>/editor-discovirtual" height="1000px" frameborder="0"
style="border:0; width:100%;" scrolling="yes"></iframe>
                         
                                            
                </div><!-- /.modal-body -->
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-embossed" data-dismiss="modal">Cancelar e fechar</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    ...
    <div class="modal fade videoModal" id="videoModal" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-dialog" style="width: 1000px; display: block; margin: 0 auto;">
            <div class="modal-content" id="videoModalContent">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Fechar</span></button>
                    <h4 class="modal-title" id="myModalLabel"><span class="fui-upload"></span> Vídeos</h4>
                </div>
                <div class="modal-body">
                                        
                    <iframe id="videoIframe" src="/<? echo $url[0].'/'.$url[1].'/'.$url[2].'/'.$url[3];?>/editor-videos" height="1000px" frameborder="0"
style="border:0; width:100%;" scrolling="yes"></iframe>
    ...
    <div class="modal fade audioModal" id="audioModal" tabindex="-1" role="dialog" aria-hidden="true">
                                                    
        <div class="modal-dialog" style="width: 1000px; display: block; margin: 0 auto;">
            <div class="modal-content" id="audioModalContent">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Fechar</span></button>
                    <h4 class="modal-title" id="myModalLabel"><span class="fui-upload"></span> Áudios</h4>
                </div>
                <div class="modal-body">
                                        
                    <iframe id="audioIframe" src="/<? echo $url[0].'/'.$url[1].'/'.$url[2].'/'.$url[3];?>/editor-audios" height="1000px" frameborder="0"
style="border:0; width:100%;" scrolling="yes"></iframe>
    ...
    <div class="modal fade viewPic" id="viewPic" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><span class="fui-cross"></span> Fechar</button>
                </div>
    ...
    <div class="modal fade deleteImageModal" id="deleteImageModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Fechar</span></button>
                    <h4 class="modal-title" id="myModalLabel"><span class="fui-info"></span> Tem certeza?</h4>
                </div>
                        
                <div class="modal-body">
                
                    <p>
                        Deletar essa imagem é permanente e <b>não pode ser desfeito</b>. Tem certeza que quer continuar?
                    </p>
                
                </div><!-- /.modal-body -->
                                
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><span class="fui-cross"></span> Cancelar</button>
                    <button type="button" class="btn btn-primary" id="deleteImageButton"><span class="fui-check"></span> Deletar imagem permanentemente</button>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    Tem certeza que quer apagar este bloco?
                    
                </div><!-- /.modal-body -->
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-embossed" data-dismiss="modal">Cancelar e Fechar</button>
                    <button type="button" type="button" class="btn btn-primary btn-embossed" id="deleteBlockConfirm">Apagar</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <p>
                        Tem certeza que quer resetar este bloco?
                    </p>
                    <p>
                        Todas as mudanças feitas neste conteúdo serão destruídas.
                    </p>
                    
                </div><!-- /.modal-body -->
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-embossed" data-dismiss="modal">Cancelar e Fechar</button>
                    <button type="button" type="button" class="btn btn-primary btn-embossed" id="resetBlockConfirm">Resetar Bloco</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <p>
                        Tem certeza que quer apagar este elemento? Uma vez apagado, ele não pode ser restaurado.
                    </p>
                    
                </div><!-- /.modal-body -->
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-embossed" data-dismiss="modal" id="deletePageCancel">Cancelar e Fechar</button>
                    <button type="button" type="button" class="btn btn-primary btn-embossed" id="deleteElementConfirm">Apagar Bloco</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>
                        Você tem alterações pendentes, se você deixar esta página suas mudanças serão perdidas. Tem certeza?
                    </p>
                                    
                </div><!-- /.modal-body -->
                                
                <div class="modal-footer">
                    <button type="button" class="btn btn-inverse" data-dismiss="modal"><span class="fui-cross"></span> Ficar nesta página!</button>
                    <a href="#" class="btn btn-primary btn-embossed" id="leavePageButton"><span class="fui-check"></span> Deixar página</a>
                </div>
    ...
    <div class="modal fade" id="editContentModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-embossed" data-dismiss="modal">Cancelar e Fechar</button>
                    <button type="button" type="button" class="btn btn-primary btn-embossed" id="updateContentInFrameSubmit">Atualizar Conteúdo</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    ...
    <div class="modal fade errorModal" id="errorModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-dialog modal-sm">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-block" data-dismiss="modal"><span class="fui-cross"></span> Fechar Janela</button>
                </div>
    ...
    <script type="text/javascript" src="/assets/plugins/ibrepbuilder/bundles/builder.bundle.js"></script>
    <script src="/assets/js/validation.js"></script>
    <script src="/assets/plugins/fancybox/source/jquery.fancybox.pack.js?v=2.1.5" type="text/javascript"></script>
