  ...
  <div class="container-fluid">
    <section id="global">
      ...
      <ul class="breadcrumb">
        ...
        <? } else { ?>
          <li class="active"><?php echo $linha["idfaq"]; ?></li>
        <? } ?>
          ...
          <div class="tabbable tabs-left">
            ...
            <div class="ava-conteudo"> 
              ...
              <?php if($url[5] != "cadastrar") { ?>
                ...
                <?php include("inc_submenu_faqs.php"); ?>
              <?php } ?>
              <div class="tab-pane active" id="tab_editar">
                ...
                <form method="post" onsubmit="return validateFields(this, regras)" enctype="multipart/form-data" class="form-horizontal">
                  <input name="acao" type="hidden" value="salvar_faq" />
                  <? if($url[6] == "editar") {
                    echo '<input type="hidden" name="'.$config["banco_faqs"]["primaria"].'" id="'.$config["banco_faqs"]["primaria"].'" value="'.$linha[$config["banco_faqs"]["primaria"]].'" />';
                    foreach($config["banco_faqs"]["campos_unicos"] as $campoid => $campo) {
                    ?>
                      <input name="<?= $campo["campo_form"]; ?>_antigo" id="<?= $campo["campo_form"]; ?>_antigo" type="hidden" value="<?= $linha[$campo["campo_banco"]]; ?>" />
                    <? 
                    }				  
                    $linhaObj->GerarFormulario("formulario_faqs",$linha,$idioma);				
                  } else {
                    $linhaObj->GerarFormulario("formulario_faqs",$_POST,$idioma);
                  }
                  ?>
    ...
    <script type="text/javascript">
      ...
      <?php
      foreach($config["formulario_faqs"] as $fieldsetid => $fieldset) {
