          ...
          <div class="tabbable tabs-left">
            ...
            <div class="ava-conteudo">
              ...
              <div class="tab-pane active" id="tab_editar">
                ...
                <?php if ($_POST && !isset($_POST['remover'])): ?>
                  <div class="alert alert-error fade in">
                    <a href="javascript:void(0);" class="close" data-dismiss="alert">×</a>
                    <strong><?= $idioma["form_erros"]; ?></strong>
                    <br /><?php echo $idioma["remover_vazio"]; ?>
                  </div>
                 <?php endif; ?>
                ...
                <form method="post" action="" class="form-horizontal">
                  <input name="acao" type="hidden" value="remover_chat" />
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <label class="checkbox">
                        <input name="remover" value="<?= $linha[$config["banco_chats"]["primaria"]]; ?>" type="checkbox" id="remover">
