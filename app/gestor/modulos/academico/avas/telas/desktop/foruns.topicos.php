        ...
        <div class="principal-area">
          ...
          <div class="principal-texto">
            ...
            <div class="forum-breadcrumbs">
              ...
              <?php if($linhaObj->verificaPermissao($perfil["permissoes"], $url[2]."|41", false)) { ?>
                ...
                <div id="cadastrartopico" style="display:none;">                
                    <iframe id="iframe_cadastrartopico" src="/<?php echo $url[0]; ?>/<?php echo $url[1]; ?>/<?php echo $url[2]; ?>/<?php echo $url[3]; ?>/<?php echo $url[4]; ?>/<?php echo $url[5]; ?>/<?php echo $url[6]; ?>/cadastrar" width="900" height="650" frameborder="0"></iframe>
                </div>
			  <?php } ?>
            </div>
            <div class="row-fluid">
