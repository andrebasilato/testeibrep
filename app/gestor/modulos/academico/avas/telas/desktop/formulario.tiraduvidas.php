...
function valida_form(form, ru) {
	CKEDITOR.instances.form_pergunta.updateElement();
...
<body>
  ...
  <div class="container-fluid">
            ...
            <div class="ava-conteudo"> 
              ...
              <div class="tab-pane active" id="tab_editar">
                ...
                <form method="post" onsubmit="return valida_form(this, regras)" enctype="multipart/form-data" class="form-horizontal">
                  <input name="acao" type="hidden" value="salvar_duvida" />
                  <? if($url[6] == "editar") {
                    ...
                    foreach($config["banco_tira_duvidas"]["campos_unicos"] as $campoid => $campo) {
                    ?>
                      <input name="<?= $campo["campo_form"]; ?>_antigo" id="<?= $campo["campo_form"]; ?>_antigo" type="hidden" value="<?= $linha[$campo["campo_banco"]]; ?>" />
                    <? 
                    }					  
                    $linhaObj->GerarFormulario("formulario_tira_duvidas",$linha,$idioma);				
                  } else {
                    $linhaObj->GerarFormulario("formulario_tira_duvidas",$_POST,$idioma);
                  }
                  ?>
    ...
    <script type="text/javascript">
	  ...
	  regras.push("required,form_pergunta,<?php echo $idioma["pergunta_vazio"]; ?>");
		<?php
		foreach($config["formulario_tira_duvidas"] as $fieldsetid => $fieldset) {
