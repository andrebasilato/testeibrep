        ...
        <div class="box-conteudo box-ava">
          <div class="tabbable tabs-left">
            ...
            <div class="ava-conteudo">
              ...
              <h2 class="tituloEdicao"><?php echo $linha['titulo']; ?></h2>
              ...
              <div class="tab-pane active" id="tab_editar">
                ...
                <form method="post" action="" class="form-horizontal">
                  <input name="acao" type="hidden" value="remover_video" />
                  <div class="control-group">
                    <p>
                      <br />
                      <? printf($idioma['usuario_selecionado'],$linha['titulo']); ?>
                      <br />
                      <br />
                      <?= $idioma["informacoes"]; ?>
                      <br />
                    ...
                    <div class="controls">
                      <label class="checkbox">
                        <input name="remover" value="<?= $linha[$config["banco_videos"]["primaria"]]; ?>" type="checkbox" id="remover">
