  ...
  <div class="container-fluid">
    <section id="global">
      ...
      <ul class="breadcrumb">
        ...
        <li><a href="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/<?= $linha["idava"]; ?>/enquetes/<?= $linha["idenquete"]; ?>/editar"><?= $linha["idenquete"]; ?></a> <span class="divider">/</span></li>
        ...
        <div class="box-conteudo box-ava">
          <div class="tabbable tabs-left">
            ...
            <div class="ava-conteudo"> 
              ...
              <h2 class="tituloEdicao"><?php echo $linha["pergunta"]; ?></h2>
              ...
              <div class="tab-pane active" id="tab_editar">
                ...
                <form method="post" action="" class="form-horizontal">
                  <input name="acao" type="hidden" value="remover_enquete" />
                  <div class="control-group">
                    <p> 
                      <br />
                      <? printf($idioma["usuario_selecionado"],$linha["pergunta"]); ?>
                      <br />
                      <br />
                      <?= $idioma["informacoes"]; ?>
                      <br />
                    ...
                    <div class="controls">
                      <label class="checkbox">
                        <input name="remover" value="<?= $linha[$config["banco_enquetes"]["primaria"]]; ?>" type="checkbox" id="remover">
