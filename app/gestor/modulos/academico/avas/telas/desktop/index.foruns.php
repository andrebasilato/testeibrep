            ...
            <div class="ava-conteudo"> 
              ...
              <div class="tab-pane active" id="tab_editar">
                ...
                <div id="listagem_informacoes"> 		  
                  ...
                  <? if($linhaObj->verificaPermissao($perfil["permissoes"], $url[2]."|50", NULL)){ ?>
                    <span class="pull-right" style="padding-top:3px; color:#999">
                      <a href="javascript:void(0)" onclick="window.open('/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/<?= $url[3]; ?>/<?= $url[4]; ?>/acessar','foruns','scrollbars=yes,width=1000,height=600').focus();" style="color:#FFF;" class="btn btn-primary"><?= $idioma["nav_acessar"]; ?></a>
                    </span>
                  <? } ?>
				  <? if($linhaObj->verificaPermissao($perfil["permissoes"], $url[2]."|26", NULL)){ ?>
                    <span class="pull-right" style="padding-top:3px; margin-right:10px; color:#999">
                ...
                <?php $linhaObj->GerarTabela($foruns,$_GET["q"],$idioma,"listagem_foruns"); ?>
