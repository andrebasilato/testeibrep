  ...
  <div class="container-fluid">
    <section id="global">
      ...
      <ul class="breadcrumb">
        ...
        <li><a href="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/<?= $linha["idava"]; ?>/objetodivisor"><?= $idioma["pagina_titulo_interno"]; ?></a> <span class="divider">/</span></li>
            ...
            <div class="ava-conteudo"> 
              ...
              <div class="tab-pane active" id="tab_editar">
                ...
                <form method="post" action="" class="form-horizontal">
                  <input name="acao" type="hidden" value="remover_objeto_divisor" />
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <label class="checkbox">
                        <input name="remover" value="<?= $linha[$config["banco_objetos_divisores"]["primaria"]]; ?>" type="checkbox" id="remover">
                    ...
                    <div class="form-actions">
                      ...
                      <input type="reset" class="btn" onclick="MM_goToURL('parent','/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/<?= $url[3]; ?>/<?= $url[4]; ?>');" value="<?= $idioma["cancelar"]; ?>" />
                    </div>
                  </div>					  
                </form>
              </div>
