            ...
            <div class="ava-conteudo"> 
              ...
              <div class="tab-pane active" id="tab_editar">
                ...
                <form method="post" action="" class="form-horizontal">
                  <input name="acao" type="hidden" value="remover_faq" />
                  <div class="control-group">
                    <p> 
                      <br />
                      <? printf($idioma["usuario_selecionado"],$linha["idfaq"]); ?>
                      <br />
                      <br />
                      <?= $idioma["informacoes"]; ?>
                      <br />
                    ...
                    <div class="controls">
                      <label class="checkbox">
                        <input name="remover" value="<?= $linha[$config["banco_faqs"]["primaria"]]; ?>" type="checkbox" id="remover">
