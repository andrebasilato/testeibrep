  ...
  <div class="container-fluid">
    <section id="global">
      ...
      <ul class="breadcrumb">
        ...
        <li><a href="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/<?= $linha["idava"]; ?>/editar"><? echo strlen($linha["ava"]) > 30 ? mb_strimwidth($linha["ava"], 0, 50, "...") : $linha["ava"]; ?></a> <span class="divider">/</span> </li>
        ...
        <div class="box-conteudo box-ava">
          <div class="tabbable tabs-left">
            ...
            <div class="ava-conteudo"> 
              ...
              <h2 class="tituloEdicao"><?php echo wordwrap($linha["nome"], 30, " ", true); ?></h2>
              ...
              <div class="tab-pane active" id="tab_editar">
                ...
                <div class="alert alert-error fade in">
                    <a href="javascript:void(0);" class="close" data-dismiss="alert">×</a>
                      <?php echo $idioma['impossivel_excluir_simulado']; ?>
                </div>
                <?php } ?>  
                <form method="post" action="" class="form-horizontal">
                  <input name="acao" type="hidden" value="remover_simulado" />
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <label class="checkbox">
                        <input name="remover" value="<?= $linha[$config["banco_simulados"]["primaria"]]; ?>" type="checkbox" id="remover">
