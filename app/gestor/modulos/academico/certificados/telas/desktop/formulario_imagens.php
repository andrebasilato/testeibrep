...
<body>
  ...
  <div class="row-fluid">
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab_editar">
                ...
                <form method="post" onsubmit="return validateFields(this, regras)" enctype="multipart/form-data" class="form-horizontal">
                  <input name="acao" type="hidden" value="salvar_imagem" />
				  <? if($url[4] == "editar") {
					...
					<?
  			   		...
  			   		$linhaObj->GerarFormulario("formulario_midias",$linha,$idioma);
  				  } else {
  		  			$linhaObj->GerarFormulario("formulario_midias",$_POST,$idioma);
  				  }
				  ?>
    ...
    <script type="text/javascript">
      ...
      <?php
      foreach($config["formulario_midias"] as $fieldsetid => $fieldset) {
