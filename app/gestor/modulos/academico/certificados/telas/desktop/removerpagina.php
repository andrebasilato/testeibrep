...
<h2 class="tituloOpcao"><?= $idioma["titulo_opcao"]; ?></h2>
          ...
          <form method="post" action="" class="form-horizontal">
            ...
            <p>
              <? printf($idioma["usuario_selecionado"],$page["nome"], $page['certificados_paginas']); ?>
              <br />
              <br />
            ...
            <div class="form-actions">
              <a type="submit" id="enviar" href="<?php echo Request::url('0-3', '/') . $page['idcertificado'] .'/removerpagina/id/'.Request::url('4'); ?>/true" class="btn btn-primary" style="color: #FFFFFF"><?= $idioma["remover"]; ?>	</a>&nbsp;
              <button type="reset" class="btn" onclick="MM_goToURL('parent','/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/<?= $page["idcertificado"]; ?>    /paginas');"><?= $idioma["cancelar"]; ?></button>
            </div>
          </form>
        </div>
      </div>
