                        ...
                        <tr>
                          ...
                          <td>
                            <?php if($perfil["permissoes"][$url[2]."|7"]) { ?>
                              <a href="javascript:void(0);" class="btn btn-mini" data-original-title="<?= $idioma["btn_remover"]; ?>" data-placement="left" rel="tooltip" onclick="remover(<?php echo $sindicato["idformula_sindicato"]; ?>)"><i class="icon-remove"></i></a>
                            <?php } else { ?>
