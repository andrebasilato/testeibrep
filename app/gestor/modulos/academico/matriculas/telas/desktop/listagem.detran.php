...
<div class="container-fluid">
    <section id="global">
        ...
        <ul class="breadcrumb">
            ...
            <? if($_GET["q"]) { ?><li><span class="divider">/</span> <a href="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/<?= $url[3]; ?>"><?= $idioma["nav_resetarbusca"]; ?></a></li><? } ?>
    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="box-conteudo">
                ...
                <?php $matriculaObj->GerarTabela($dadosArray,$_GET["q"],$idioma, 'listagem_detran'); ?>
