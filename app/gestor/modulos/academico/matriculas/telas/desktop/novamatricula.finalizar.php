        ...
        <div class="row-fluid">
          <div class="span12">
            <section id="matricula">
              ...
              <a class="btn btn-small" href="/gestor/academico/matriculas/<?= $matricula["idmatricula"]; ?>/administrar" style="margin-bottom:10px; margin-right:10px;"><?= $idioma["btn_administrar"]; ?></a>
              <a class="btn btn-small" href="/gestor/academico/matriculas/<?= $matricula["idmatricula"]; ?>/dossie" target="_blank" style="margin-bottom:10px; margin-right:10px;"><?= $idioma["btn_dossie"]; ?></a>
              <br />
