            ...
            <section id="formulario_cpf">
                ...
                <?php if(count($ofertaCursoEscolas) > 0) { ?>
                  <section class="blocoDisponibilidade" id="escolas">
                    ...
                    foreach($ofertaCursoEscolas as $ofertaCursoEscola) {
                        if($ofertaCursoEscola['contratos_nao_aceitos']) continue;
                        $i++;
                    ?>
                      <? if($i == 1) { ?>
                        <div class="row-fluid">
                      <? } ?>
                            <? if(!$ofertaCursoEscola['contratos_nao_aceitos']) { ?>
              ...
              <?php } else { ?>
				...
				?>
					...
					<div id="texto" style="display:block;" class="control-group">
					  <div class="row alert alert-error fade in" style="margin:0px;">
						<a href="javascript:void(0);" class="close" data-dismiss="alert">×</a>
				...
				<form method="post" style="border-bottom:1px #F4F4F4 solid; padding-top:15px;">
					<h4><?php echo $idioma["form_oferta_radio_titulo"];?></h4>
					<div style='margin-top: 16px;' >
						<input type="radio" id="sim" name="remover_dados" value="sim"
							checked>
						<label style='display:inline; marging:10px;' for="sim"><?php echo $idioma["form_oferta_radio_sim"];?></label>
					</div>
					<div style='margin-bottom: 16px;' >
						<input type="radio" id="nao" name="remover_dados" value="nao" >
						<label style='display:inline;' for="nao"><?php echo $idioma["form_oferta_radio_nao"];?></label>
					</div>
