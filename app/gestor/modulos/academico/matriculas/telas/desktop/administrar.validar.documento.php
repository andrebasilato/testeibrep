    ...
    <ul class="breadcrumb">
      ...
      <li class="active"><strong id="documento_nome"><?= $documento["arquivo_nome"]; ?></strong></li>
        ...
        <form action="" method="post" id="form_aprovar_documento" target="_parent">
            ...
            <input name="iddocumento" id="iddocumento" type="hidden" value="<?= $url["7"]; ?>" />
            ...
            <div class="row-fluid">
                ...
                <div class="span5 botao btn <?php if($documento["situacao"] == "reprovado") { ?>btn-danger<?php } ?>" id="documento_desaprovar" onclick="selecionarSituacaoReprovada('div_motivo_reprovacao','idmotivo');"  style="padding-top:30px;">
