...
<div class="row-fluid" >
  <div class="span12">
      ...
      <form method="post" action="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/<?= $url[3]; ?>/<?= $url[4]; ?>/<?= $url[5]; ?>/renegociar_parcelas_selecionadas/<?= $url[7]; ?>" class="form-horizontal" onsubmit="return verificaSelecao();" >
				...
				<a class="btn" href="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/<?= $url[3]; ?>/<?= $url[4]; ?>/<?= $url[5]; ?>/renegociar" ><?= $idioma["voltar"]; ?></a>
