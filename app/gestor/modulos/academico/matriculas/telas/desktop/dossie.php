...
<table width="100%" border="1" cellpadding="8" cellspacing="0">
  ...
  <tr>
    ...
    <tr>
    <td colspan="9" bgcolor="#F4F4F4"><strong><?= $idioma["simulados"]; ?></strong></td>
  </tr>
  <tr>
    <td colspan="9">
      <table cellpadding="5" cellspacing="0" class="table table-bordered table-condensed tabelaSemTamanho">
        <tr>
          <td bgcolor="#F4F4F4" style="height:30px"><strong><?= $idioma["simulado"]; ?></strong></td>
          <td bgcolor="#F4F4F4" style="height:30px"><strong><?= $idioma["quantidade_acertos"]; ?></strong></td>
        <?php if ($simulados) {

         foreach ($simulados as $simulado) { ?>
            <tr>
              <td style="height:30px"><strong><?= $simulado["simulado"]; ?></strong></td>
              <td style="height:30px"><strong><?= $simulado["total_perguntas_corretas"]."/".$simulado["total_perguntas"]; ?></strong></td>
            </tr>
        <?php }

        } else { ?>
            <tr>
                <td>Nenhum simulado encontrado!</td>
            </tr>
        <?php } ?>
      </table>
    </td>
...
<table width="100%" border="1" cellpadding="8" cellspacing="0">
  ...
  <tr> <!-- Reconhecimento facial -->
    <td colspan="9" bgcolor="#F4F4F4"><strong><?= $idioma["reconhecimento_facial"]; ?></strong></td>
  </tr>
  <tr>
        <td colspan="9">
            <table width="720" cellpadding="5" cellspacing="0" class="table table-bordered table-condensed tabelaSemTamanho">
                <tr>
                    <td bgcolor="#F4F4F4" colspan="2"><strong><?=$idioma["foto_padrao"];?></strong></td>
                </tr>
                <tr>
                    <td><?php if (is_array($imagensPriDV)) { ?>
  ...
  <tr>
    <td valign="top">
      <span style="color:#999999;">
        Gerado dia <?= date("d/m/Y "); ?> por <?= $usuario["nome"]; ?> (<?= $usuario["email"]; ?>)<br>
