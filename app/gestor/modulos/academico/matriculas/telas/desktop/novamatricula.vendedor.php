    ...
    <div class="span12">
      <div class="box-conteudo" style="padding:35px;">
        ...
        <ul id="navegacao_passos" style="margin-bottom:20px;">
          ...
          <li class="inprogress"><?= $idioma["nav_vendedor"]; ?><span></span></li>
        ...
        <div class="row-fluid">
          ...
          <div class="span9">
            <section id="formulario_cpf">
                ...
                <section id="formulario_cliente">
                  ...
                  <table border="0" cellspacing="0" cellpadding="5" class="table tabelaSemTamanho">
                    ...
                    <? foreach($vendedoresVisitas as $vendedorVisita) { ?>
                      <tr>
                          <td><strong><?= $vendedorVisita["nome"]; ?><?php if($vendedorVisita['venda_bloqueada'] == 'S') { ?><span style="color: #F00;"> [VENDA BLOQUEADA]</span><?php } ?></strong></td>
              ...
              <section id="formulario_cpf">
                <form method="get" id="buscarVendedor">
                  ...
                  <div class="control-group">
                    <div class="controls">
                      <input type="button" onclick="verificarInput()" class="btn" value="<?=$idioma["btn_buscar"];?>" />
                    </div>
                  </div>
                </form>
              </section>
                  ...
                  <table border="0" cellspacing="0" cellpadding="5" class="table tabelaSemTamanho">
                    ...
                    <?php if(count($vendedores) > 0) { ?>
                      <? foreach($vendedores as $vendedor) { ?>
                        <tr>
                          <td><strong><?= $vendedor["nome"]; ?><?php if($vendedor['venda_bloqueada'] == 'S') { ?><span style="color: #F00;"> [VENDA BLOQUEADA]</span><?php } ?></strong></td>
              ...
              <? } ?>
              <?php
                $action = "/".$url[0]."/".$url[1]."/".$url[2]."/".$url[3]."/".$url[4]."/".$url[5]."/".$url[6]."/".$url[7]."/financeiro";
                if($_SESSION['matricula']['possui_financeiro'] == 'S'){
                    $action = "/".$url[0]."/".$url[1]."/".$url[2]."/".$url[3]."/".$url[4]."/".$url[5]."/". $url[6]."/". $url[7]."/financeiro";
                }
              ?>
              <form method="post" id="form_idvendedor" action="<?= $action ?>">
  ...
  <script type="text/javascript">
      const verificarInput = () => {
          if(document.getElementById('vendedor').value === ""){
              alert("<?= $idioma["vendedor_vazio"]; ?>");
          } else {
              document.getElementById('buscarVendedor').submit();
          }
      }
