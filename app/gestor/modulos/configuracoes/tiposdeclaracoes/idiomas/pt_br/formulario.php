...
$idioma["modificar_sucesso"] = "Tipo de declaração modificado com sucesso.";
$idioma["legendadadosdados"] = "Dados do tipo de declaração";
$idioma["form_nome"] = "Nome:";
$idioma["nome_vazio"] = "Informe o nome do tipo de declaração.";
$idioma["nome_utilizado"] = "O nome informado já está sendo utilizado por outro tipo de declaração.";
