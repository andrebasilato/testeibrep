                            ...
                            <div class="form-horizontal">
                                <div class="control-group">
                                    ...
                                    <label class="control-label"
                                           for="optionsCheckboxList"><?= $idioma["confirmacao"]; ?></label>

                                    <div class="controls">
                                        <label class="checkbox">
                                            <input name="confirmacao"
                                                   value="<?= $linha[$config["banco"]["primaria"]]; ?>" type="checkbox"
                                                   id="confirmacao">
                                    ...
                                    <br/>
                                    <label class="control-label"
                                           for="optionsCheckboxList"><?= $idioma["adicionais"]; ?></label>

                                    <div class="controls">
                                        <label class="checkbox">
                                            <input name="enviar_email"
                                                   value="<?= $linha[$config["banco"]["primaria"]]; ?>" type="checkbox"
                                                   id="enviar_email">
                                            <?= $idioma["enviar_email"]; ?>
                                        </label>
                                    ...
                                    <div class="controls">
                                        <label class="checkbox">
                                            <input name="exibir_nova_senha"
                                                   value="<?= $linha[$config["banco"]["primaria"]]; ?>" type="checkbox"
                                                   id="exibir_nova_senha">
                                ...
                                <div class="form-actions">
                                    <a href="javascript:void(0);" class="btn btn-primary" id="resetar"
                                       onclick="resetarSenha();"><?= $idioma["resetar"]; ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        success: function (json) { //Se ocorrer tudo certo
                            if (json.sucesso) {
                                ...
                                if (json.exibir_nova_senha) {
                                    var msg_email;
                                    if (!json.sucesso_email) msg_email = '';
                                    else msg_email = '<?= $idioma["sucesso_email"]; ?>';
