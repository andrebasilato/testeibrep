            ...
            <div class="tabbable tabs-left">
                <?php if ($url[3] != "cadastrar") { ?>
                    <table border="0" cellspacing="0" cellpadding="8">
                        <tr>
                            <td>
                                <img src="/api/get/imagens/usuariosadm_avatar/x/120/<?php echo $linha["avatar_servidor"]; ?>" />
                            </td>
                            <td>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab_editar">
                        ...
                        <? } ?>
                        <form method="post" onsubmit="return formulario_documentos(this, regras_documentos)" enctype="multipart/form-data"
