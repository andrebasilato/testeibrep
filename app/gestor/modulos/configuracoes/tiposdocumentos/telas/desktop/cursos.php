                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_editar">
                                ...
                                <?php if ($perfil["permissoes"][$url[2] . "|5"]) { ?>
                                    <label class="checkbox">
                                        <input type="checkbox" value="S" id="todos_cursos_obrigatorio"
                                               ...
                                               <?php if ($linha["todos_cursos_obrigatorio"] == "S") { ?>checked="checked"<?php } ?>> <?= $idioma["form_todos"]; ?>
                                    </label>
                                    <p class="help-block"><?= $idioma["form_todos_ajuda"]; ?></p>
                                    <br/>
                                    <input type="hidden" id="acao" name="acao" value="todos_cursos_obrigatorio">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                <?php if (count($cursosArray) > 0) { ?>
                                    <?php foreach ($cursosArray as $ind => $curso) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($perfil["permissoes"][$url[2] . "|6"]) { ?>
                                                    <a href="javascript:void(0);" class="btn btn-mini"
                                                       ...
                                                       onclick="remover(<?php echo $curso["idtipo_curso"]; ?>)"><i
