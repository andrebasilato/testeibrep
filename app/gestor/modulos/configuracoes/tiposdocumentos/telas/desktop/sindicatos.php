                                ...
                                <?php if ($perfil["permissoes"][$url[2] . "|8"]) { ?>
                                    <label class="checkbox">
                                        <input type="checkbox" value="S" id="todas_sindicatos_obrigatorio"
                                               ...
                                               <?php if ($linha["todas_sindicatos_obrigatorio"] == "S") { ?>checked="checked"<?php } ?>> <?= $idioma["form_todas"]; ?>
                                    </label>
                                    <p class="help-block"><?= $idioma["form_todas_ajuda"]; ?></p>
                                    <br/>
                                    <input type="hidden" id="acao" name="acao" value="todas_sindicatos_obrigatorio">
