...
$config["listagem"] = array(
    ...
    array(
        ...
        "tipo" => "php",
        "valor" => 'if (empty($linha["mensagem"])) {
                        return "";
                    }

                    if ($GLOBALS["linhaObj"]->verificaPermissao($GLOBALS["perfil"]["permissoes"], $GLOBALS["url"][2] . "|2",false)) {
    ...
    array(
        ...
        "valor" => 'if (empty($linha["mensagem"])) {
                    ...
                    return "<a class=\"btn dropdown-toggle btn-mini\" data-original-title=\"".$idioma["tabela_opcoes_tooltip"]."\" href=\"/".$this->url["0"]."/".$this->url["1"]."/".$this->url["2"]."/".$linha["idemail"]."/visualizar\" data-placement=\"left\" rel=\"tooltip facebox\"><i class=\"icon-eye-open\"></i> ".$idioma["tabela_opcoes"]."</a>";',
        "busca_botao" => true,
        "tamanho" => "90"
    )
);
