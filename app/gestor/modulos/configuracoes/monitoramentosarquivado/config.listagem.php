...
$config["listagem"] = array(
    ...
    array(
        ...
        "evento" => "maxlength='100'",
        "coluna_sql" => "m.idacao",
        "valor" => ' return $GLOBALS["monitora_acao"][$linha["idacao"]]',
        "busca" => true,
        "busca_tipo" => "select",
        "busca_class" => "inputPreenchimentoCompleto",
    ...
    array(
        ...
        "valor" => ' return $GLOBALS["monitora_onde"][$linha["idonde"]]', // Se for do tipo banco o valor é o nome da coluna da tabela, se for do tipo php o valor é um script php
        "busca" => true,
        "busca_tipo" => "select",
        "busca_class" => "inputPreenchimentoCompleto",
