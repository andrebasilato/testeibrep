<?
	...
	if($url[3] && $url[4] == "visualizar"){	
		...
		$linhaObj->Set("campos","*");	
		$linha = $linhaObj->RetornarPreviewMuralDisponiveis("idusuario_adm", $usuario["idusuario"]);
		...
		$dadosArray = $linhaObj->ListarTodasDisponiveis("idusuario_adm", $usuario["idusuario"]);
