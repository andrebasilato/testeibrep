  	...
  	<div class="span12">
        <div class="box-conteudo">
     	...
     	<? if($linhaObj->verificaPermissao($perfil["permissoes"], $url[2]."|2", NULL)){ ?>
			<a href="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/cadastrarassunto" class="btn  btn-primary"><i class="icon-plus icon-white"></i> <?= $idioma["nav_novoassunto"]; ?></a>
        <? } ?>
        <? if($linhaObj->verificaPermissao($perfil["permissoes"], $url[2]."|2", NULL)){ ?>
			<a href="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/cadastrarsubassunto" class="btn  btn-primary"><i class="icon-plus icon-white"></i> <?= $idioma["nav_novosubassunto"]; ?></a>
        <? } ?> 
        </span>               
