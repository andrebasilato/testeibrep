           ...
           <h2 class="tituloOpcao"><?= $idioma["titulo_opcao"]; ?></h2>
      		...
      		<form method="post" onsubmit="return validateFields(this, regras)" enctype="multipart/form-data" class="form-horizontal">
        		...
        		<? if($url[4] == "editarsubassunto") {
					...
					$linhaObj->GerarFormulario("formulario_subassunto",$linha,$idioma);
				
				} else {
					$linhaObj->GerarFormulario("formulario_subassunto",$_POST,$idioma);
				}
				?>
...
<script type="text/javascript">
	...
	<?php
	foreach($config["formulario_subassunto"] as $fieldsetid => $fieldset) {
