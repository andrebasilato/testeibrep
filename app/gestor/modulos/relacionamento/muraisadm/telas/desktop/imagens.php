        ...
        <div class="box-conteudo">
                    ...
                    <form method="post" action="" class="well form-horizontal form-inline" enctype="multipart/form-data" onsubmit="return validateFields(this, regras)">
                      ...
                      <div class="control-group">
                          ...
                          <input type="file" name="arquivos[1]" id="arquivos[1]" /><br /><br />
                          </div>
                      </div>
                        ...
                        <tbody>
                            <?php if(count($imagensArray) > 0) { ?>
                                <?php foreach($imagensArray as $ind => $imagem) { ?>
                                    <tr>
                                        <td><?php echo $imagem["idmural_imagem"]; ?></td>
                                        <td><?= $imagem["nome"]; ?></td>
                                        <td><?php echo tamanhoArquivo($imagem["tamanho"]); ?></td>
                                        <td style="text-align:right">
                                          <?php if (strpos($imagem['tipo'],'image') !== false) { ?>
                                          <a href="<?php echo "/".$url[0]."/".$url[1]."/".$url[2]."/".$url[3]."/visualiza_imagem/".$imagem["idmural_imagem"]; ?>" rel="facebox tooltip" class="btn btn-mini" data-original-title="<?= $idioma["btn_visualizar"]; ?>" data-placement="left"><i class="icon-picture"></i> <?php echo $idioma["visualizar"]; ?></a> <?php } ?>                                          
                                           <?php if($perfil["permissoes"][$url[2]."|6"]) { ?>
                                          <a href="<?php echo "/".$url[0]."/".$url[1]."/".$url[2]."/".$url[3]."/download/".$imagem["idmural_imagem"]; ?>" class="btn btn-mini" data-original-title="<?= $idioma["btn_download"]; ?>" data-placement="left" rel="tooltip">
                                          ...
                                          <a href="javascript:void(0);" class="btn btn-mini" data-original-title="<?= $idioma["btn_remover"]; ?>" data-placement="left" rel="tooltip" onclick="remover(<?php echo $imagem["idmural_imagem"]; ?>)"><i class="icon-remove"></i></a>                                          
                                          <?php } else { ?>
