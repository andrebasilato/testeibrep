<?
  if ($_GET['clonada_sucesso']) $_POST["msg"] = "pesquisa_".$_GET['clonada_sucesso'];
?>
        	...
        	<div class="tabbable tabs-left">
				...
				<div class="tab-content">
				  <div class="tab-pane active" id="tab_editar">
					...
					<? } ?>
					<form method="post" onsubmit="return validateFields(this, regras)" enctype="multipart/form-data" class="form-horizontal" id="form-pergunta">
...
<script type="text/javascript">	
	...
	jQuery(document).ready(function($) {
		$("fieldset").addClass("form-width");
		 $(".form-width").css( "width","82%" );
