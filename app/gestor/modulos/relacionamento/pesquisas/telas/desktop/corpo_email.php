              		...
              		<div class="tab-content">
                		<div class="tab-pane active" id="tab_editar">
    						...
    						<form class="well" method="post">
                                ...
                                <p><?= $idioma["tipo"]; ?></p>
                                <p><select name="email_padrao" id="email_padrao">
                                	<option value="S" <?php if ($linha["corpo_email"] == "S"){?>selected="selected"<?php } ?>><?= $idioma["tipo_padrao"];?></option>
                                    <option value="N" <?php if ($linha["corpo_email"] == "N"){?>selected="selected"<?php } ?>><?= $idioma["tipo_personalizado"];?></option>
                                </select></p><br />
                                
                                <div id="div_mostrar_corpo" style="display: none;">
                                ...
                                <div id="div_form_botao_variaveis" style="display: none;">
                                    ...
                                    <table class="table-striped table-bordered table-condensed" width="100%">
                                        ...
                                        <tr>
                                            <td><strong><?= $idioma["variavel_link"]; ?></strong></td>
                                            <td><?= $idioma["texto_variavel_link"]; ?></td>
                                        </tr>
                                    </table>
                                </div>
