			 		...
			 		<?php incluirTela("inc_menu_edicao",$config,$usuario); ?>
              		<div class="tab-content">
                		<div class="tab-pane active" id="tab_editar">
    						...
    						<div class="well">
                                <a href="javascript:void(0);" style="color:#FFF;" class="btn btn-primary" onclick='window.open("/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/<?= $url[3] ?>/previewpopup", "popupwindow", "scrollbars=yes,width=1000,height=600").focus()'><?= $idioma["btn_popup"]; ?></a>
                            </div>
						</div>
              		</div>
            	</div>                           
