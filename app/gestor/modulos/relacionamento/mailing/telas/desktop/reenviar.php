            ...
            <div class="tabbable tabs-left">
              ...
              <div class="tab-content">
                <div class="tab-pane active" id="tab_editar">
					...
					<form method="post">
						<?php if ($linha["situacao"] == 2) { ?>
						<input type="hidden" value="reenviar_mailing" name="act" />
						<?php } ?>
						<br />                        
						<div class="row-fluid">
							<input type="submit" class="botao btn" id="desativarLogin" value="<?php echo $idioma['reenviar_mailing']; ?>" <?php if ($linha["situacao"] < 2) { ?> disabled="disabled" <?php } ?> />				
						</div>  
					</form>
