...
<div class="container-fluid">
  ...
  <div class="row-fluid">
        ...
        <div class="box-conteudo">
            ...
            <div class="tabbable tabs-left">
      		...
      		<form method="post" onsubmit="return validateFields(this, regras)" enctype="multipart/form-data" class="form-horizontal">
                <input name="acao" type="hidden" value="cadastrar_imagem" />
				<input type="hidden" name="idcontrato" value="<?= $url[3]; ?>" />
                ...
                <? if($url[4] == "editar") {
                    ...
                    $linhaObj->GerarFormulario("formulario_imagem",$linha,$idioma);
     ...
     <?php $linhaObj->GerarTabela($dadosArray,$_GET["q"],$idioma, 'listagem_imagem'); ?>
    </div>
  </div>
...
<script type="text/javascript">
    $('#cadastrar-arquivo').bind('change', function() {
        if(this.files[0].size > 8388608)
        {
            $('#cadastrar').attr("disabled", true);
            alert('Ops! Tamanho do arquivo inserido é muito grande. O máximo permitido são 8 MB');
        } else {
