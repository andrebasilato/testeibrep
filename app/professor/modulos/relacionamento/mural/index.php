<?
	...
	if($url[3] && $url[4] == "visualizar"){	
		...
		$linhaObj->Set("campos","*");	
		$linha = $linhaObj->RetornarPreviewMuralDisponiveis("idprofessor", $usu_professor["idprofessor"]);
		...
		$dadosArray = $linhaObj->ListarTodasDisponiveis("idprofessor", $usu_professor["idprofessor"]);
