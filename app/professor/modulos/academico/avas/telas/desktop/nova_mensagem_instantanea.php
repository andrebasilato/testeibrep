...
<body>
	<div class="content" style="min-width: 800px !important;">
								...
								<div class="span12"> <!-- coluna 1 -->
									<div>
										...
										<div class="forum-base-titulo corbgVerde-claro">
											<?= $idioma["buscar_usuarios"]; ?>
										</div>
										<form id="form_iniciar_conversa" name="form_iniciar_conversa" method="post" enctype="multipart/form-data" onsubmit="return validateFields(this, regras);">
											<ul style="overflow: auto; width: 100%;" class="forum-listagem chat-participante">
												<li>
													<input name="acao" type="hidden" value="iniciar_chat" />
													<select id="participantes" name="participantes"></select>
												</li>
												<li>
													<div class="forum-form">
														<div class="forum-base-titulo corbgpadrao" style="height:170px">
															<input type="hidden" id="acao" name="acao" value="iniciar_chat" />
															<textarea id="mensagem" name="mensagem" class="chat-texarea corbgpadrao" placeholder="<?php echo $idioma["escreva"]; ?>"></textarea>
															<input type="file" id="arquivo" name="arquivo" />
															<input class="corbgpadrao btfade chat-bt" type="submit" value="<?php echo $idioma["enviar"]; ?>" />
														</div>
													</div>
												</li>
											</ul>
