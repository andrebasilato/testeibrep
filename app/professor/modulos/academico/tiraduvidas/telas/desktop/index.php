        ...
        <div class="span12">
            <div class="box-conteudo">
                ...
                <div id="listagem_informacoes">
                    <?
                    //printf($idioma["informacoes"],count($duvidas));
                    printf($idioma["informacoes"],$mensagemObj->Get("total"));
                    ?>
                    <br />
                    <? printf($idioma["paginas"],$mensagemObj->Get("pagina"),$mensagemObj->Get("paginas")); ?>
                    <? /*if($mensagemObj->verificaPermissao($perfil["permissoes"], $url[2]."|2", NULL)){ ?>
			...
			<? }*/ ?>
                ...
                <?php $mensagemObj->GerarTabela($duvidas,$_GET["q"],$idioma); ?>
                    ...
                    <div class="input">
                        <div class="inline-inputs">
                            ...
                            <form action="" method="get" id="formQtd">
                                ...
                                <? } ?>
                                <input name="qtd" type="text" class="span1" id="qtd" maxlength="4" value="<?= $mensagemObj->Get("limite"); ?>" />
                                <a href="javascript:document.getElementById('formQtd').submit();" class="btn small"><?= $idioma["exibir"]; ?></a>
                            </form>
                        </div>
                    </div>
                </div>
                <? if($mensagemObj->Get("paginas") > 1) { ?>
                    <div class="pagination"><ul><?= $mensagemObj->GerarPaginacao($idioma); ?></ul></div>
                <? } ?>
