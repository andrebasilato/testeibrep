...
<div class="content">
  <div class="conteudo">
    <?php if($linhaObj->verificaPermissao($forum["permissoes"], $url[0]."|topicos|4", false)) { ?>
      <form action="" method="post" id="form_ocultar_topico">
        <input name="acao" id="acao_ocultar_topico" type="hidden" value="" />
      </form>
    <?php } ?>
    <?php if($linhaObj->verificaPermissao($forum["permissoes"], $url[0]."|mensagens|1", false)) { ?>
    ...
    <?php } ?>
    <?php if($linhaObj->verificaPermissao($forum["permissoes"], $url[0]."|topicos|3", false)) { ?>
          ...
          <div class="principal-texto">
            ...
            <div class="forum-breadcrumbs">
              <div class="forum-breadcrumbs-bts corpadrao">
                ...
                <a href="/<?php echo $url[0]; ?>/<?php echo $url[1]; ?>/<?php echo $url[2]; ?>/<?php echo $url[3]; ?>/<?php echo $url[4]; ?>/<?php echo $url[5]; ?>/<?php echo $url[6]; ?>"><?php echo $topico["nome"]; ?></a> >
                <a href="/<?php echo $url[0]; ?>/<?php echo $url[1]; ?>/<?php echo $url[2]; ?>/<?php echo $url[3]; ?>/<?php echo $url[4]; ?>/<?php echo $url[5]; ?>/<?php echo $url[6]; ?>"><?php echo $idioma["mensagens"]; ?></a>
              </div>
              <?php if($linhaObj->verificaPermissao($forum["permissoes"], $url[0]."|topicos|2", false) && $topico["bloqueado"] == "desbloqueado") { ?>
                <a href="/<?php echo $url[0]; ?>/<?php echo $url[1]; ?>/<?php echo $url[2]; ?>/<?php echo $url[3]; ?>/<?php echo $url[4]; ?>/<?php echo $url[5]; ?>/<?php echo $url[6]; ?>/cadastrar" class="corbgVerde-escuro bts-forum-criar" rel="facebox"><?php echo $idioma["responder_topico"]; ?></a>
              <?php } ?>
            </div>
            <div class="row-fluid">
                  ...
                  <li>
                    <div class="forum-interna-conteudo">
                      ...
                      <?php if($topico["arquivo_servidor"]) { ?>
                          <p>
                            <a href="/<?php echo $url[0]; ?>/<?php echo $url[1]; ?>/<?php echo $url[2]; ?>/<?php echo $url[3]; ?>/<?php echo $url[4]; ?>/<?php echo $url[5]; ?>/download"><?php echo $idioma['arquivo'].': '.$topico["arquivo_nome"].' ('.tamanhoArquivo($topico["arquivo_tamanho"]).')'; ?></a>
                          </p>
                      <?php } ?>
                      <div class="forum-interna-botoes">
                        ...
                        <?php } ?>
						<?php if($linhaObj->verificaPermissao($forum["permissoes"], $url[0]."|mensagens|3", false)) { ?>
                          ...
                          <div id="moderartopico" style="display:none;">
                            <iframe id="iframe_moderartopico" src="/<?php echo $url[0]; ?>/<?php echo $url[1]; ?>/<?php echo $url[2]; ?>/<?php echo $url[3]; ?>/<?php echo $url[4]; ?>/<?php echo $url[5]; ?>/moderar" width="900" height="650" frameborder="0"></iframe>
                          </div>
						<?php } ?>
                        <?php if($linhaObj->verificaPermissao($forum["permissoes"], $url[0]."|topicos|2", false) && $topico["bloqueado"] == "desbloqueado") { ?>
                          <a href="/<?php echo $url[0]; ?>/<?php echo $url[1]; ?>/<?php echo $url[2]; ?>/<?php echo $url[3]; ?>/<?php echo $url[4]; ?>/<?php echo $url[5]; ?>/<?php echo $url[6]; ?>/cadastrar" class="corbg-btlaranja btfade" rel="facebox"><?php echo $idioma["responder_mensagem"]; ?><img src="/assets/aluno/img/forum/ico_responder.png" height="17" width="20"/></a>
						<?php } ?>
                      </div>
                    </div>
                  </li>
					  ...
					  if($resposta["oculto"] == "N" || ($resposta["oculto"] == "S" && $linhaObj->verificaPermissao($forum["permissoes"], $url[0]."|mensagens|2", false))) {
						...
						<li>
						  ...
						  <div class="forum-interna-conteudo">
							...
							<?php } 
							if($resposta["moderado"] == "S" && $linhaObj->verificaPermissao($forum["permissoes"], $url[0]."|mensagens|4", false)) { ?>
							  <div class="forum-citacao">
								<h3><?php echo $idioma["mensagem_original"]; ?></h3>
                            ...
                            <?php if($resposta["arquivo_servidor"]) { ?>
                                <p>
                                    <a href="/<?php echo $url[0]; ?>/<?php echo $url[1]; ?>/<?php echo $url[2]; ?>/<?php echo $url[3]; ?>/<?php echo $url[4]; ?>/<?php echo $url[5]; ?>/<?php echo $url[6]; ?>/<?php echo $resposta["idmensagem"]; ?>/download"><?php echo $idioma['arquivo'].': '.$resposta["arquivo_nome"].' ('.tamanhoArquivo($resposta["arquivo_tamanho"]).')'; ?></a>
                                </p>
							<?php } ?>
							<div class="forum-interna-botoes">
							  <?php if($linhaObj->verificaPermissao($forum["permissoes"], $url[0]."|topicos|6", false)) { ?>
							  ...
							  <?php } ?>
							  <?php if($linhaObj->verificaPermissao($forum["permissoes"], $url[0]."|mensagens|3", false)) { ?>
                                <a href="/<?php echo $url[0]; ?>/<?php echo $url[1]; ?>/<?php echo $url[2]; ?>/<?php echo $url[3]; ?>/<?php echo $url[4]; ?>/<?php echo $url[5]; ?>/<?php echo $url[6]; ?>/<?php echo $resposta["idmensagem"]; ?>/moderar" class="<?php if($resposta["moderado"] == "S") { ?>corbgcinza<?php } else {  ?>corbg-btlaranja<?php } ?> btfade" rel="facebox"><?php if($resposta["moderado"] == "S") { echo $idioma["moderado_mensagem"]; } else { echo $idioma["moderar_mensagem"]; } ?><img src="/assets/aluno/img/forum/ico_editar.png" height="17" width="20"/></a>
							  <?php } ?>
							  <?php if($linhaObj->verificaPermissao($forum["permissoes"], $url[0]."|topicos|2", false) && $topico["bloqueado"] == "desbloqueado") { ?>
                                <a href="/<?php echo $url[0]; ?>/<?php echo $url[1]; ?>/<?php echo $url[2]; ?>/<?php echo $url[3]; ?>/<?php echo $url[4]; ?>/<?php echo $url[5]; ?>/<?php echo $url[6]; ?>/<?php echo $resposta["idmensagem"]; ?>/responder" class="corbg-btlaranja btfade" rel="facebox"><?php echo $idioma["responder_mensagem"]; ?><img src="/assets/aluno/img/forum/ico_responder.png" height="17" width="20"/></a>
                              <?php } ?>
							</div>
						  </div>
						</li>
  ...
  <?php if($linhaObj->verificaPermissao($forum["permissoes"], $url[0]."|topicos|6", false)) { ?>
	$(function() {
	  $(".votar").click(function() {
		...
		$.ajax({
		  type: "POST",
		  url: "/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/<?= $url[3]; ?>/<?= $url[4]; ?>/<?= $url[5]; ?>/<?= $url[6]; ?>/json/curtir",
		  data: dataString,
		  cache: false,
