...
function scrollSideBar() {
    ...
    if ($(".sidebarForm").length > 0) {
        if (pos > $(".conteudoForm").offset().top - 30) {
            $(".sidebarForm").find('.conteudoSideBar').css({
                position: 'fixed',
                width: $(".sidebarForm").width(),
                top: "30px"
            });
            $(".conteudoSideBar p" ).css('display', 'none');;
        }
        if (pos < $(".conteudoForm").offset().top - 30) {
            $(".sidebarForm").find('.conteudoSideBar').css({
                position: 'absolute',
            ...
            $(".conteudoSideBar p" ).css('display', 'block');;
        }
        if (pos > ($(".conteudoForm").offset().top + $(".conteudoForm").height()) - $(".sidebarForm").find('.conteudoSideBar').height() - 30) {
            $(".sidebarForm").find('.conteudoSideBar').css({
                position: 'absolute',
                width: "calc(100% - 30px)",
                top: $(".sidebarForm").height() - $(".sidebarForm").find('.conteudoSideBar').height()
            });
        }
    }
}
