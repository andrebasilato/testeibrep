<?php
class Perguntas extends Ava {
		
  var $idava = NULL;
  
  function ListarTodasPergunta() {		
	$this->sql = "select 
					".$this->campos." 
				  from
					avas_perguntas p
					inner join avas a on (p.idava = a.idava)
				  where 
					p.ativo = 'S' and 
					a.idava = ".$this->idava;
