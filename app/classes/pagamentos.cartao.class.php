<?php 
class PagamentosCartao extends Core {
  ...
  function ListarTodas() {		
	$this->sql = "SELECT ".$this->campos." 
				  ...
				  INNER JOIN bandeiras_cartoes b ON b.idbandeira = c.idbandeira
				  LEFT OUTER JOIN matriculas m ON m.idmatricula = c.idmatricula
				  LEFT OUTER JOIN pessoas p ON p.idpessoa = m.idpessoa
	 			WHERE (c.forma_pagamento = 2 or c.forma_pagamento = 3)  AND c.ativo = 'S'";
