...
require_once $_SERVER['DOCUMENT_ROOT'] . '/classes/reconhecimento/HTTP/Request2/Adapter.php';

/** Socket wrapper class */
require_once $_SERVER['DOCUMENT_ROOT'] . '/classes/reconhecimento/HTTP/Request2/SocketWrapper.php';
