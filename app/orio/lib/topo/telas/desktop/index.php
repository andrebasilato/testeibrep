    ...
    <div class="navbar-inner">
      <div class="container-fluid">
        ...
        <ul class="dropdown-menu">
          <li><a href="/orio/configuracoes/meusdados"><i class='icon-asterisk'></i> Meus dados</a></li>
          <li class="divider"></li>
		  <form id="form_manual" method="post" action="<?= $GLOBALS["config"]["link_manual"]; ?>/orio" target="_blanck">
      ...
      <div class="nav-collapse collapse">
        <ul class="nav" id="menu-topbar" style="display:none;">
          ...
          <li><a href="/<?= $url[0]; ?>/transacoes?q%5B1%7Ctipo%5D=E"> <?= $idioma["entrada"]; ?></a></li>
          <li><a href="/<?= $url[0]; ?>/transacoes?q%5B1%7Ctipo%5D=S"> <?= $idioma["saida"]; ?></a></li>
          <li><a href="/<?= $url[0]; ?>/transacoes?q%5B1%7Csituacao%5D=1"> <?= $idioma["pendente"]; ?></a></li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div id="menuLogo" class="hidden-phone">
    ...
    <div id="divMenu">
      <ul id="menu">
        ...
        <li class="semSubMenu">
          <a href="/<?= $url[0]; ?>/transacoes?q%5B1%7Ctipo%5D=E">
            <div class="divImagem"><img src="/assets/icones/branco/24/download_branco.png" /></div>
            <div class="divImagemHover"><img src="/assets/icones/preto/24/download_preto.png" /></div>
            <?= $idioma["entrada"]; ?>
          </a>
        </li>

        <li class="semSubMenu">
          <a href="/<?= $url[0]; ?>/transacoes?q%5B1%7Ctipo%5D=S">
            <div class="divImagem"><img src="/assets/icones/branco/24/upload_branco.png" /></div>
            <div class="divImagemHover"><img src="/assets/icones/preto/24/upload_preto.png" /></div>
            <?= $idioma["saida"]; ?>
          </a>
        </li>

        <li class="semSubMenu">
          <a href="/<?= $url[0]; ?>/transacoes?q%5B1%7Csituacao%5D=1">
              <div class="divImagem"><i class="fa fa-refresh" style="font-size:24px;" aria-hidden="true"></i></div>
              <div class="divImagemHover"><i class="fa fa-refresh" style="font-size:24px;" aria-hidden="true"></i></div>
              <?= $idioma["pendente"]; ?>
          </a>
        </li>
        ...
        <li class="menu_right">
            <a href="/<?= $url[0] ?>?opLogin=sair">
                <div class="divImagem"><i class="fa fa-arrow-circle-o-right" style="font-size:24px;" aria-hidden="true"></i></div>
                <div class="divImagemHover"><i class="fa fa-arrow-circle-o-right" style="font-size:24px;" aria-hidden="true"></i></div>
                <?= $idioma["sair"]; ?>
            </a>
        </li>
      </ul>
